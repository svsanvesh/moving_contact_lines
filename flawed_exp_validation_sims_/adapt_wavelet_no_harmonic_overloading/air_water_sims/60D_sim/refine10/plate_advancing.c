...
//The geometry of the problem is a sqaure domain of size 15 x 15 (ALL LENGTHS IN m )
...
double H0;
	...
	#define T_end 100 
        ...
        #define f_tol 1e-3    // The tolerance given to the vof field f. 
...
event adapt (i += 5) {
  adapt_wavelet ((scalar*){f}, (double[]){f_tol},maxlevel, maxlevel-2);
}
