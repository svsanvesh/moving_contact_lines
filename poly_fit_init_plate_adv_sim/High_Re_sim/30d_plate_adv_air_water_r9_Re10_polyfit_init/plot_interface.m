...
% C= sortrows(B);
% 
% plot(C(:,1) +Domain/2,C(:,2), 'r','LineWidth',2, 'MarkerSize',10 )
% 
% ylabel('Downward moving plate','FontWeight','Bold','FontSize',20);
% xlabel('Particle diameter (\mum)','FontWeight','Bold','FontSize',20);
% set(gca,'Fontsize',12,'Fontname','Times New Roman')
...
plot(D(:,1) +Domain/2,D(:,2), 'g','LineWidth',2, 'MarkerSize',10 )
...
% %% Time step - 5.0
% % The file ' interface_profile_t5.000000.dat ' is loaded in as an array and is
% % used to plot the interafce shape at the corresponding timestep. 
% 
% E=load('interface_profile_t5.000000.dat');
% E= sortrows(B);
% 
% plot(E(:,1) +Domain/2,E(:,2), 'c','LineWidth',2, 'MarkerSize',10 )
% 
% ylabel('Downward moving plate','FontWeight','Bold','FontSize',20);
% xlabel('Particle diameter (\mum)','FontWeight','Bold','FontSize',20);
% set(gca,'Fontsize',12,'Fontname','Times New Roman')
