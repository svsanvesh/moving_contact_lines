...
#line 1 "plate_advancing.c"
#line 28 "plate_advancing.c"
...
static int init_0_expr0 (int * ip, double * tp, Event * _ev) {  int i = *ip; double t = *tp;  int ret = (i = 0);   *ip = i; *tp = t;   return ret; } static int init_0 (const int i, const double t, Event * _ev) { trace ("init_0", "/home/fpl/softwares/basilisk/src/contact.h", 45);  {
  strongif (interfaces) for (scalar c = *interfaces, *_i109 = interfaces; ((scalar *)&c)->i >= 0; c = *++_i109)
...
static int acceleration_0_expr0 (int * ip, double * tp, Event * _ev) {  int i = *ip; double t = *tp;  int ret = (i++);   *ip = i; *tp = t;   return ret; } static int acceleration_0 (const int i, const double t, Event * _ev) { trace ("acceleration_0", "/home/fpl/softwares/basilisk/src/iforce.h", 43); 
{
  ...
  scalar * list = NULL;
  strongif (interfaces) for (scalar f = *interfaces, *_i111 = interfaces; ((scalar *)&f)->i >= 0; f = *++_i111)
...
#line 72 "/home/fpl/softwares/basilisk/src/iforce.h"
  strongif (list) for (scalar f = *list, *_i112 = list; ((scalar *)&f)->i >= 0; f = *++_i112) {
...
#line 87 "/home/fpl/softwares/basilisk/src/iforce.h"
    ...
    strongif (list) for (scalar f = *list, *_i113 = list; ((scalar *)&f)->i >= 0; f = *++_i113)
...
#line 108
 end_foreach_face(); } }
  ...
  strongif (list) for (scalar f = *list, *_i114 = list; ((scalar *)&f)->i >= 0; f = *++_i114) {
...
#line 49
  ...
  double sigma = 0.;
  strongif (interfaces) for (scalar c = *interfaces, *_i116 = interfaces; ((scalar *)&c)->i >= 0; c = *++_i116)
...
static int acceleration_1_expr0 (int * ip, double * tp, Event * _ev) {  int i = *ip; double t = *tp;  int ret = (i++);   *ip = i; *tp = t;   return ret; } static int acceleration_1 (const int i, const double t, Event * _ev) { trace ("acceleration_1", "/home/fpl/softwares/basilisk/src/tension.h", 72); 
{
  ...
  strongif (interfaces) for (scalar f = *interfaces, *_i117 = interfaces; ((scalar *)&f)->i >= 0; f = *++_i117)
...
{
  strongif (interfaces) for (scalar c = *interfaces, *_i118 = interfaces; ((scalar *)&c)->i >= 0; c = *++_i118) {
    ...
    strongif (tracers) for (scalar t = *tracers, *_i119 = tracers; ((scalar *)&t)->i >= 0; t = *++_i119) {
...
{
  strongif (interfaces) for (scalar c = *interfaces, *_i120 = interfaces; ((scalar *)&c)->i >= 0; c = *++_i120) {
    scalar * tracers = _attribute[c.i].tracers;
    strongif (tracers) for (scalar t = *tracers, *_i121 = tracers; ((scalar *)&t)->i >= 0; t = *++_i121)
...
#line 97 "/home/fpl/softwares/basilisk/src/two-phase.h"
 {
    ...
    IF (mu1 || mu2) {
      vector muv = mu;
      _stencil_val(__FILE__,__LINE__,muv.x,0,0,0) = val_fm_x(fm.x,0,0,0)*(1./(clamp(ff,0,1)*(1./mu1 - 1./mu2) + 1./mu2));
    }
  } }  }}  { int jg = -1; VARIABLES;  strongif (is_stencil_face_y()) {
#line 97
{
...
#line 97 "/home/fpl/softwares/basilisk/src/two-phase.h"
 {
    ...
    IF (mu1 || mu2) {
      vector muv = mu;
      _stencil_val(__FILE__,__LINE__,muv.y,0,0,0) = val_fm_y(fm.y,0,0,0)*(1./(clamp(ff,0,1)*(1./mu1 - 1./mu2) + 1./mu2));
    }
  } }  }}  end_foreach_face_stencil()
#line 104
 }
...
void output_pvtu_ascii (scalar * list, vector * vlist, int n, FILE * fp, char * subname)
{
    ...
    strongif (list) for (scalar s = *list, *_i125 = list; ((scalar *)&s)->i >= 0; s = *++_i125) {
      fprintf (fp,"\t\t\t\t <PDataArray type=\"Float64\" Name=\"%s\" format=\"ascii\">\n", _attribute[s.i].name);
      fputs ("\t\t\t\t </PDataArray>\n", fp);
    }
    strongif (vlist) for (vector v = *vlist, *_i126 = vlist; ((scalar *)&v)->i >= 0; v = *++_i126) {
...
#line 58
  ...
  strongif (list) for (scalar s = *list, *_i127 = list; ((scalar *)&s)->i >= 0; s = *++_i127) {
...
#line 69
  ...
  strongif (vlist) for (vector v = *vlist, *_i128 = vlist; ((scalar *)&v)->i >= 0; v = *++_i128) {
...
void output_pvtu_bin (scalar * list, vector * vlist, int n, FILE * fp, char * subname)
{
    ...
    fputs ("\t <PUnstructuredGrid GhostLevel=\"0\">\n", fp);
    fputs ("\t\t\t <PCellData Scalars=\"scalars\">\n", fp);
    strongif (list) for (scalar s = *list, *_i129 = list; ((scalar *)&s)->i >= 0; s = *++_i129) {
      fprintf (fp,"\t\t\t\t <PDataArray type=\"Float64\" Name=\"%s\" format=\"appended\">\n", _attribute[s.i].name);
      fputs ("\t\t\t\t </PDataArray>\n", fp);
    }
    strongif (vlist) for (vector v = *vlist, *_i130 = vlist; ((scalar *)&v)->i >= 0; v = *++_i130) {
...
#line 216
  ...
  int count = 0;
  strongif (list) for (scalar s = *list, *_i131 = list; ((scalar *)&s)->i >= 0; s = *++_i131) {
    fprintf (fp,"\t\t\t\t <DataArray type=\"Float64\" Name=\"%s\" format=\"appended\" offset=\"%d\">\n", _attribute[s.i].name,count);
    count += ((no_cells)+1)*8;
    fputs ("\t\t\t\t </DataArray>\n", fp);
  }
  strongif (vlist) for (vector v = *vlist, *_i132 = vlist; ((scalar *)&v)->i >= 0; v = *++_i132) {
...
#line 289
  ...
  strongif (list) for (scalar s = *list, *_i133 = list; ((scalar *)&s)->i >= 0; s = *++_i133) {
...
#line 303
  ...
  strongif (vlist) for (vector v = *vlist, *_i134 = vlist; ((scalar *)&v)->i >= 0; v = *++_i134) {
    fwrite (&block_len, sizeof (unsigned long long), 1, fp);
     { 
#if _OPENMP
  #undef OMP
...
#endif
 delete (((scalar []){marker,{-1}})); }
#line 35 "plate_advancing.c"

int maxlevel = 9;
char name_vtk[100];
double U0;
double H0;
#line 59 "plate_advancing.c"
double h0;
...
{ _init_solver();
        L0 = 0.015;
 origin ((struct _origin){0, -L0/2});
 N = 1024;
        stokes = true;
        _attribute[f.i].sigma = 0.072;
        _attribute[f.i].height = h;
        ;

        theta0 = 120*pi/180.0;
        _attribute[h.y.i].boundary[left] = _boundary8; _attribute[h.y.i].boundary_homogeneous[left] = _boundary8_homogeneous; _attribute[h.y.i].dirty = true;
        _attribute[h.y.i].boundary[right] = _boundary9; _attribute[h.y.i].boundary_homogeneous[right] = _boundary9_homogeneous; _attribute[h.y.i].dirty = true;
...
static int init_1_expr0 (int * ip, double * tp, Event * _ev) {  int i = *ip; double t = *tp;  int ret = (t = 0);   *ip = i; *tp = t;   return ret; } static int init_1 (const int i, const double t, Event * _ev) { trace ("init_1", "plate_advancing.c", 96); 
{
 if(!restore ((struct Dump){.file = "---- "}))
  {
...
{ double theta0 = _theta0; NOT_UNUSED(theta0);
  static bool _first_call = true;
  ForeachData _foreach_data = {
    .fname = "plate_advancing.c", .line = 104,
    .each = "foreach_vertex", .first = _first_call
  };
foreach_vertex_stencil(){

#line 104 "plate_advancing.c"
 _stencil_val(__FILE__,__LINE__,phi,0,0,0) = 0.001557050 + y + 0.0027/(tan(theta0)*exp((x)/0.0027)); } end_foreach_vertex_stencil(); if (_first_call) {
 if (theta0 != _theta0)
   reduction_warning ("plate_advancing.c", 104, "theta0");
 }
  _first_call = false;
}}
enable_fpe (FE_DIVBYZERO|FE_INVALID);
...
#line 104 "plate_advancing.c"
 val(phi,0,0,0) = 0.001557050 + y + 0.0027/(tan(theta0)*exp((x)/0.0027)); } end_foreach_vertex(); } fractions ((struct Fractions){phi, f});  delete (((scalar []){phi,{-1}})); } while(0);
 boundary_internal ((scalar *)(((scalar []){f,{-1}})), "plate_advancing.c", 105);

   { 
disable_fpe (FE_DIVBYZERO|FE_INVALID);
{ {  static bool _first_call = true;
  ForeachData _foreach_data = {
    .fname = "plate_advancing.c", .line = 107,
    .each = "foreach", .first = _first_call
  };
foreach_stencil(){

#line 107 "plate_advancing.c"
...
#line 110
   ...
   {
   _stencil_val(__FILE__,__LINE__,u.x,0,0,0)=0.0;

   }
#line 110

   {
   _stencil_val(__FILE__,__LINE__,u.y,0,0,0)=0.0;
...
#line 110
 ...
 end_trace("init_1", "plate_advancing.c", 120); } return 0; } 




static int acceleration_2_expr0 (int * ip, double * tp, Event * _ev) {  int i = *ip; double t = *tp;  int ret = (i++);   *ip = i; *tp = t;   return ret; } static int acceleration_2 (const int i, const double t, Event * _ev) { trace ("acceleration_2", "plate_advancing.c", 125); 
{
        vector av = a;
         { 
disable_fpe (FE_DIVBYZERO|FE_INVALID);
{ {  static bool _first_call = true;
  ForeachData _foreach_data = {
    .fname = "plate_advancing.c", .line = 128,
    .each = "foreach_face", .first = _first_call
  };
foreach_face_stencil() { int ig = -1; VARIABLES;  strongif (is_stencil_face_x()) {
#line 128
...
#line 128 "plate_advancing.c"

                _stencil_val(__FILE__,__LINE__,av.y,0,0,0) = -9.81; }  }}  end_foreach_face_stencil()
#line 129
  _first_call = false;
}}
enable_fpe (FE_DIVBYZERO|FE_INVALID);
...
#line 129
 end_foreach_face(); }
 end_trace("acceleration_2", "plate_advancing.c", 130); } return 0; } 
...
static int logfile_expr0 (int * ip, double * tp, Event * _ev) {  int i = *ip; double t = *tp;  int ret = (i+=50);   *ip = i; *tp = t;   return ret; } static int logfile (const int i, const double t, Event * _ev) { trace ("logfile", "plate_advancing.c", 151); 
        fprintf (ferr, "%d %g\n", i, t); end_trace("logfile", "plate_advancing.c", 152);  return 0; } 




static int profile_expr0 (int * ip, double * tp, Event * _ev) {  int i = *ip; double t = *tp;  int ret = (t+=0.1 );   *ip = i; *tp = t;   return ret; } static int profile_expr1 (int * ip, double * tp, Event * _ev) {   int i = *ip; double t = *tp;   int ret = ( t <= 100 );   *ip = i; *tp = t;   return ret; } static int profile (const int i, const double t, Event * _ev) { trace ("profile", "plate_advancing.c", 157); 
{
  char int_prof[80];
  sprintf(int_prof,"interface_profile_t%2f.dat", t);
  FILE * fp1 = fopen(int_prof,"w");
  output_facets ((struct OutputFacets){f, fp1});
 end_trace("profile", "plate_advancing.c", 163); } return 0; } 
#line 189 "plate_advancing.c"
static int dumpfile_expr0 (int * ip, double * tp, Event * _ev) {  int i = *ip; double t = *tp;  int ret = (i+=100 );   *ip = i; *tp = t;   return ret; } static int dumpfile_expr1 (int * ip, double * tp, Event * _ev) {   int i = *ip; double t = *tp;   int ret = (t <= 100);   *ip = i; *tp = t;   return ret; } static int dumpfile (const int i, const double t, Event * _ev) { trace ("dumpfile", "plate_advancing.c", 189); 
{
    char name[80];
    sprintf(name,"dump-%d",i/100);
    scalar pid= new_scalar("pid");
     { 
disable_fpe (FE_DIVBYZERO|FE_INVALID);
{ {  static bool _first_call = true;
  ForeachData _foreach_data = {
    .fname = "plate_advancing.c", .line = 194,
    .each = "foreach", .first = _first_call
  };
foreach_stencil(){

#line 194 "plate_advancing.c"
...
#line 194 "plate_advancing.c"
    ...
    boundary_internal ((scalar *)(((scalar []){pid,{-1}})), "plate_advancing.c", 198);
    dump ((struct Dump){name});
 delete (((scalar []){pid,{-1}}));  end_trace("dumpfile", "plate_advancing.c", 200); } return 0; } 



static int adapt_0_expr0 (int * ip, double * tp, Event * _ev) {  int i = *ip; double t = *tp;  int ret = (i += 5);   *ip = i; *tp = t;   return ret; } static int adapt_0 (const int i, const double t, Event * _ev) { trace ("adapt_0", "plate_advancing.c", 204);  {
  adapt_wavelet ((struct Adapt){(scalar*)((scalar []){f,u.x,u.y,{-1}}), (double[]){0.1,0.05,0.05},maxlevel , maxlevel-3 });
 end_trace("adapt_0", "plate_advancing.c", 206); } return 0; } 

static int logfile_0_expr0 (int * ip, double * tp, Event * _ev) {  int i = *ip; double t = *tp;  int ret = (t = 0);   *ip = i; *tp = t;   return ret; } static int logfile_0_expr1 (int * ip, double * tp, Event * _ev) {   int i = *ip; double t = *tp;   int ret = ( t += 0.01);   *ip = i; *tp = t;   return ret; } static int logfile_0_expr2 (int * ip, double * tp, Event * _ev) {   int i = *ip; double t = *tp;   int ret = ( t <= 100);   *ip = i; *tp = t;   return ret; } static int logfile_0 (const int i, const double t, Event * _ev) { trace ("logfile_0", "plate_advancing.c", 208); 
{
    if (pid() == 0)
    {
        FILE *trackfile;
    ...
    nf++;
 end_trace("logfile_0", "plate_advancing.c", 221); } return 0; } 
#line 91 "/home/fpl/softwares/basilisk/src/navier-stokes/centered.h"
...
#line 133 "plate_advancing.c"
return  dirichlet(-0.00013145); return 0.; } static double _boundary11_homogeneous (Point point, Point neighbor, scalar _s, void * data) { int ig = neighbor.i - point.i;  strongif (ig == 0) ig = _attribute[_s.i].d.x;  NOT_UNUSED(ig); int jg = neighbor.j - point.j;  strongif (jg == 0) jg = _attribute[_s.i].d.y;  NOT_UNUSED(jg); POINT_VARIABLES; 
#line 133 "plate_advancing.c"
return  dirichlet_homogeneous(); return 0.; }
#line 137 "plate_advancing.c"
...
#line 142 "plate_advancing.c"
return  dirichlet(0.); return 0.; } static double _boundary15_homogeneous (Point point, Point neighbor, scalar _s, void * data) { int ig = neighbor.i - point.i;  strongif (ig == 0) ig = _attribute[_s.i].d.x;  NOT_UNUSED(ig); int jg = neighbor.j - point.j;  strongif (jg == 0) jg = _attribute[_s.i].d.y;  NOT_UNUSED(jg); POINT_VARIABLES; 
#line 142 "plate_advancing.c"
return  dirichlet_homogeneous(); return 0.; }
#line 145 "plate_advancing.c"
...
static int profile_expr1 (int * ip, double * tp, Event * _ev);
...
static int logfile_0 (const int i, const double t, Event * _ev);
static int logfile_0_expr0 (int * ip, double * tp, Event * _ev);
static int logfile_0_expr1 (int * ip, double * tp, Event * _ev);
static int logfile_0_expr2 (int * ip, double * tp, Event * _ev);
...
void _init_solver (void) {
  ...
  event_register ((Event){ 0, 1, init_1, {init_1_expr0}, ((int *)0), ((double *)0),
    "plate_advancing.c", 96, "init"});
  event_register ((Event){ 0, 1, logfile, {logfile_expr0}, ((int *)0), ((double *)0),
    "plate_advancing.c", 151, "logfile"});
  event_register ((Event){ 0, 3, logfile_0, {logfile_0_expr0, logfile_0_expr1, logfile_0_expr2}, ((int *)0), ((double *)0),
    "plate_advancing.c", 208, "logfile"});
  event_register ((Event){ 0, 2, profile, {profile_expr0, profile_expr1}, ((int *)0), ((double *)0),
    "plate_advancing.c", 157, "profile"});
  event_register ((Event){ 0, 2, dumpfile, {dumpfile_expr0, dumpfile_expr1}, ((int *)0), ((double *)0),
    "plate_advancing.c", 189, "dumpfile"});
  ...
  event_register ((Event){ 0, 1, acceleration_2, {acceleration_2_expr0}, ((int *)0), ((double *)0),
    "plate_advancing.c", 125, "acceleration"});
