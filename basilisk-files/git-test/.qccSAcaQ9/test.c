...
#line 1 "/opt/basilisk/src/common.h"
#include <stdlib.h>
#include <stdio.h>
#include <stddef.h>
#include <stdbool.h>
...
{ trace ("mpi_all_reduce0", "/opt/basilisk/src/common.h", 672);
  { int _ret =  MPI_Allreduce (sendbuf, recvbuf, count, datatype, op, comm); end_trace("mpi_all_reduce0", "/opt/basilisk/src/common.h", 673);  return _ret; }
 end_trace("mpi_all_reduce0", "/opt/basilisk/src/common.h", 674); }
#define mpi_all_reduce(v,type,op) {\
...
#line 816 "/opt/basilisk/src/common.h"
...
#line 895 "/opt/basilisk/src/common.h"
...
#line 1 "/opt/basilisk/src/grid/boundaries.h"
...
#line 47 "/opt/basilisk/src/grid/boundaries.h"
typedef struct {
  Boundary parent;
  int d;
} BoxBoundary;
#line 940 "/opt/basilisk/src/common.h"
...
#line 943 "/opt/basilisk/src/common.h"
...
#line 1218 "/opt/basilisk/src/common.h"
...
#line 1 "/opt/basilisk/src/grid/quadtree.h"


#line 1 "grid/tree.h"
#line 1 "/opt/basilisk/src/grid/tree.h"
#line 1 "grid/mempool.h"
#line 1 "/opt/basilisk/src/grid/mempool.h"
...
#line 2 "/opt/basilisk/src/grid/tree.h"
#line 22 "/opt/basilisk/src/grid/tree.h"
typedef struct {
...
#line 200 "/opt/basilisk/src/grid/tree.h"
...
#line 349 "/opt/basilisk/src/grid/tree.h"
...
#line 409 "/opt/basilisk/src/grid/tree.h"
...
#line 1 "/opt/basilisk/src/grid/foreach_cell.h"
#line 66 "/opt/basilisk/src/grid/foreach_cell.h"
...
#line 469 "/opt/basilisk/src/grid/tree.h"
#line 486 "/opt/basilisk/src/grid/tree.h"
...
#line 532 "/opt/basilisk/src/grid/tree.h"
...
#line 1 "/opt/basilisk/src/grid/neighbors.h"
#line 17 "/opt/basilisk/src/grid/neighbors.h"
...
{ int ig = 0; NOT_UNUSED(ig); int jg = 0; NOT_UNUSED(jg); POINT_VARIABLES; 
#line 659 "/opt/basilisk/src/grid/tree.h"
...
#line 682 "/opt/basilisk/src/grid/tree.h"
}
...
{
#line 713 "/opt/basilisk/src/grid/tree.h"
}
...
#line 721 "/opt/basilisk/src/grid/tree.h"
...
#line 732 "/opt/basilisk/src/grid/tree.h"
 {
...
#line 756 "/opt/basilisk/src/grid/tree.h"
    if (!(cell.pid < 0)) {
...
#line 834 "/opt/basilisk/src/grid/tree.h"
...
#line 885 "/opt/basilisk/src/grid/tree.h"
...
#line 942 "/opt/basilisk/src/grid/tree.h"
  }
}
...
{ int ig = 0; NOT_UNUSED(ig); int jg = 0; NOT_UNUSED(jg); POINT_VARIABLES; 
#line 970 "/opt/basilisk/src/grid/tree.h"
...
#line 1008 "/opt/basilisk/src/grid/tree.h"
  }
...
#line 1037 "/opt/basilisk/src/grid/tree.h"
static void free_children (Point point)
{ int ig = 0; NOT_UNUSED(ig); int jg = 0; NOT_UNUSED(jg); POINT_VARIABLES; 
#line 1038 "/opt/basilisk/src/grid/tree.h"
...
#line 1077 "/opt/basilisk/src/grid/tree.h"
void increment_neighbors (Point point)
{ int ig = 0; NOT_UNUSED(ig); int jg = 0; NOT_UNUSED(jg); POINT_VARIABLES; 
#line 1078 "/opt/basilisk/src/grid/tree.h"
...
{ int ig = 0; NOT_UNUSED(ig); int jg = 0; NOT_UNUSED(jg); POINT_VARIABLES; 
#line 1089 "/opt/basilisk/src/grid/tree.h"
...
{
#line 1127 "/opt/basilisk/src/grid/tree.h"
  if (Period.y) {
...
#line 1152 "/opt/basilisk/src/grid/tree.h"
}
...
void realloc_scalar (int size)
{
  ...
  for (int l = 1; l <= depth(); l++) {
    ...
    for (int i = Period.x*2; i < len - Period.x*2; i += 2)
      if (L->m[i]) {
#line 1194 "/opt/basilisk/src/grid/tree.h"
...
#line 1217 "/opt/basilisk/src/grid/tree.h"
   }
...
{ int ig = 0; NOT_UNUSED(ig); int jg = 0; NOT_UNUSED(jg); POINT_VARIABLES; 
#line 1246 "/opt/basilisk/src/grid/tree.h"
...
{ int ig = 0; NOT_UNUSED(ig); int jg = 0; NOT_UNUSED(jg); POINT_VARIABLES; 
#line 1274 "/opt/basilisk/src/grid/tree.h"
...
static bool diagonal_neighbor_3D (Point point,
      scalar * scalars, vector * vectors)
{ int ig = 0; NOT_UNUSED(ig); int jg = 0; NOT_UNUSED(jg); POINT_VARIABLES; 
#line 1315 "/opt/basilisk/src/grid/tree.h"

#line 1357 "/opt/basilisk/src/grid/tree.h"
  return false;
}
...
{ int ig = 0; NOT_UNUSED(ig); int jg = 0; NOT_UNUSED(jg); POINT_VARIABLES; 
#line 1363 "/opt/basilisk/src/grid/tree.h"
...
#line 1382 "/opt/basilisk/src/grid/tree.h"
...
#line 1403 "/opt/basilisk/src/grid/tree.h"
 {
...
{ int ig = 0; NOT_UNUSED(ig); int jg = 0; NOT_UNUSED(jg); POINT_VARIABLES; 
#line 1468 "/opt/basilisk/src/grid/tree.h"
...
{ int ig = 0; NOT_UNUSED(ig); int jg = 0; NOT_UNUSED(jg); POINT_VARIABLES; 
#line 1478 "/opt/basilisk/src/grid/tree.h"
...
#line 1500 "/opt/basilisk/src/grid/tree.h"
 {
...
#line 1540 "/opt/basilisk/src/grid/tree.h"
...
#line 1596 "/opt/basilisk/src/grid/tree.h"
  for (int l = 0; l <= depth(); l++)
    destroy_layer (q->L[l]);
  q->L = &(q->L[-1]);
...
{ trace ("init_grid", "/opt/basilisk/src/grid/tree.h", 1612);
  ...
  Layer * L = new_layer (0);
  q->L[0] = L;
#line 1652 "/opt/basilisk/src/grid/tree.h"
  for (int i = Period.x*2; i < L->len - Period.x*2; i++) {
    layer_add_row (L, i, 0);
    for (int j = Period.y*2; j < L->len - Period.y*2; j++)
  ...
  for (int k = - 2*(1 - Period.x); k <= 2*(1 - Period.x); k++)
    for (int l = -2*(1 - Period.y); l <= 2*(1 - Period.y); l++)
      CELL(L->m[2 +k][2 +l]).pid = (k < 0 ? -1 - left :
         ...
         0);
  CELL(L->m[2][2]).pid = 0;
#line 1692 "/opt/basilisk/src/grid/tree.h"
  ...
  reset (all, 0.);
  { if (((Tree *)grid)->dirty) update_cache_f(); };
 end_trace("init_grid", "/opt/basilisk/src/grid/tree.h", 1710); }
...
#line 1715 "/opt/basilisk/src/grid/tree.h"
...
#line 1751 "/opt/basilisk/src/grid/tree.h"
 ...
 return point;
  ...
  Point point = {0};  int ig = 0; NOT_UNUSED(ig); int jg = 0; NOT_UNUSED(jg); POINT_VARIABLES; 
#line 1775 "/opt/basilisk/src/grid/tree.h"
...
#line 1 "/opt/basilisk/src/grid/tree-common.h"



#line 1 "grid/multigrid-common.h"
#line 1 "/opt/basilisk/src/grid/multigrid-common.h"


#line 1 "grid/cartesian-common.h"
#line 1 "/opt/basilisk/src/grid/cartesian-common.h"
#line 1 "grid/events.h"
#line 1 "/opt/basilisk/src/grid/events.h"
...
#line 131 "/opt/basilisk/src/grid/events.h"
...
#line 2 "/opt/basilisk/src/grid/cartesian-common.h"
...
#line 1 "grid/fpe.h"
#line 1 "/opt/basilisk/src/grid/fpe.h"
...
#line 35 "/opt/basilisk/src/grid/cartesian-common.h"
...
#line 172
 {
    ...
    t.y.x = t.x.y;
#line 192 "/opt/basilisk/src/grid/cartesian-common.h"
  init_tensor (t, NULL);
  return t;
}
...
{ trace ("boundary", "/opt/basilisk/src/grid/cartesian-common.h", 345);
  if (list == NULL)
    { ; end_trace("boundary", "/opt/basilisk/src/grid/cartesian-common.h", 347);  return; }
  vector * listf = NULL;
 ...
 end_trace("boundary", "/opt/basilisk/src/grid/cartesian-common.h", 357); }
...
{ int ig = 0; NOT_UNUSED(ig); int jg = 0; NOT_UNUSED(jg); POINT_VARIABLES; 
#line 370 "/opt/basilisk/src/grid/cartesian-common.h"
...
{ int ig = 0; NOT_UNUSED(ig); int jg = 0; NOT_UNUSED(jg); POINT_VARIABLES; 
#line 375 "/opt/basilisk/src/grid/cartesian-common.h"
...
#line 504 "/opt/basilisk/src/grid/cartesian-common.h"
 {
    bool inside = true;
    coord o = {x,y,z};
    {
 ...
 inside = false;}
    if (inside) {
      ...
      fprintf (p.fp, "%g %g\n%g %g\n%g %g\n%g %g\n%g %g\n\n",
        ...
        x + Delta, y - Delta,
        x - Delta, y - Delta);
#line 536 "/opt/basilisk/src/grid/cartesian-common.h"
    }
  } } end_foreach(); }
  fflush (p.fp);
}
#line 548 "/opt/basilisk/src/grid/cartesian-common.h"
...
{ int ig = 0; NOT_UNUSED(ig); int jg = 0; NOT_UNUSED(jg); POINT_VARIABLES; 
#line 582 "/opt/basilisk/src/grid/cartesian-common.h"
  ...
  fputc ('\n', fp);
#line 615 "/opt/basilisk/src/grid/cartesian-common.h"
    for (int k = -2; k <= 2; k++)
      for (int l = -2; l <= 2; l++) {
...
#line 645 "/opt/basilisk/src/grid/cartesian-common.h"
  fclose (fp);
...
{ int ig = 0; NOT_UNUSED(ig); int jg = 0; NOT_UNUSED(jg); POINT_VARIABLES; 
#line 686 "/opt/basilisk/src/grid/cartesian-common.h"
...
#line 714 "/opt/basilisk/src/grid/cartesian-common.h"
}


double interpolate (struct _interpolate p)
{ trace ("interpolate", "/opt/basilisk/src/grid/cartesian-common.h", 718);
  Point point = locate ((struct _locate){p.x, p.y, p.z});  int ig = 0; NOT_UNUSED(ig); int jg = 0; NOT_UNUSED(jg); POINT_VARIABLES; 
#line 719 "/opt/basilisk/src/grid/cartesian-common.h"

  if (point.level < 0)
    { double _ret =  nodata; end_trace("interpolate", "/opt/basilisk/src/grid/cartesian-common.h", 721);  return _ret; }
  { double _ret =  interpolate_linear (point, p); end_trace("interpolate", "/opt/basilisk/src/grid/cartesian-common.h", 722);  return _ret; }
 end_trace("interpolate", "/opt/basilisk/src/grid/cartesian-common.h", 723); }


void interpolate_array (scalar * list, coord * a, int n, double * v, bool linear)
{ trace ("interpolate_array", "/opt/basilisk/src/grid/cartesian-common.h", 727);
  int j = 0;
  for (int i = 0; i < n; i++) {
    Point point = locate ((struct _locate){a[i].x, a[i].y, a[i].z});  int ig = 0; NOT_UNUSED(ig); int jg = 0; NOT_UNUSED(jg); POINT_VARIABLES; 
#line 730 "/opt/basilisk/src/grid/cartesian-common.h"
 ...
 v[j++] = nodata;
  ...
  MPI_MIN, 0, MPI_COMM_WORLD);
#endif
 end_trace("interpolate_array", "/opt/basilisk/src/grid/cartesian-common.h", 749); }
...
{ int ig = 0; NOT_UNUSED(ig); int jg = 0; NOT_UNUSED(jg); POINT_VARIABLES; 
#line 781 "/opt/basilisk/src/grid/cartesian-common.h"
...
#line 4 "/opt/basilisk/src/grid/multigrid-common.h"
...
{ int ig = 0; NOT_UNUSED(ig); int jg = 0; NOT_UNUSED(jg); POINT_VARIABLES; 
#line 27 "/opt/basilisk/src/grid/multigrid-common.h"
...
{ int ig = 0; NOT_UNUSED(ig); int jg = 0; NOT_UNUSED(jg); POINT_VARIABLES; 
#line 35 "/opt/basilisk/src/grid/multigrid-common.h"
...
{ int ig = 0; NOT_UNUSED(ig); int jg = 0; NOT_UNUSED(jg); POINT_VARIABLES; 
#line 43 "/opt/basilisk/src/grid/multigrid-common.h"
...
{ int ig = 0; NOT_UNUSED(ig); int jg = 0; NOT_UNUSED(jg); POINT_VARIABLES; 
#line 61 "/opt/basilisk/src/grid/multigrid-common.h"
...
{ int ig = 0; NOT_UNUSED(ig); int jg = 0; NOT_UNUSED(jg); POINT_VARIABLES; 
#line 66 "/opt/basilisk/src/grid/multigrid-common.h"
...
#line 90 "/opt/basilisk/src/grid/multigrid-common.h"
 {
       { foreach_child()
...
#line 104 "/opt/basilisk/src/grid/multigrid-common.h"
...
#line 111 "/opt/basilisk/src/grid/multigrid-common.h"
...
#line 115 "/opt/basilisk/src/grid/multigrid-common.h"
 {
      _attribute[s.i].prolongation (point, s);
       { foreach_child()
...
{ int ig = 0; NOT_UNUSED(ig); int jg = 0; NOT_UNUSED(jg); POINT_VARIABLES; 
#line 125 "/opt/basilisk/src/grid/multigrid-common.h"
...
#line 140 "/opt/basilisk/src/grid/multigrid-common.h"
}

static inline void refine_bilinear (Point point, scalar s)
{ int ig = 0; NOT_UNUSED(ig); int jg = 0; NOT_UNUSED(jg); POINT_VARIABLES; 
#line 143 "/opt/basilisk/src/grid/multigrid-common.h"
...
{ int ig = 0; NOT_UNUSED(ig); int jg = 0; NOT_UNUSED(jg); POINT_VARIABLES; 
#line 154 "/opt/basilisk/src/grid/multigrid-common.h"
...
{ int ig = 0; NOT_UNUSED(ig); int jg = 0; NOT_UNUSED(jg); POINT_VARIABLES; 
#line 175 "/opt/basilisk/src/grid/multigrid-common.h"
...
{ int ig = 0; NOT_UNUSED(ig); int jg = 0; NOT_UNUSED(jg); POINT_VARIABLES; 
#line 188 "/opt/basilisk/src/grid/multigrid-common.h"
...
{ int ig = 0; NOT_UNUSED(ig); int jg = 0; NOT_UNUSED(jg); POINT_VARIABLES; 
#line 194 "/opt/basilisk/src/grid/multigrid-common.h"
...
{ int ig = 0; NOT_UNUSED(ig); int jg = 0; NOT_UNUSED(jg); POINT_VARIABLES; 
#line 214 "/opt/basilisk/src/grid/multigrid-common.h"
...
{ int ig = 0; NOT_UNUSED(ig); int jg = 0; NOT_UNUSED(jg); POINT_VARIABLES; 
#line 220 "/opt/basilisk/src/grid/multigrid-common.h"
...
{ int ig = 0; NOT_UNUSED(ig); int jg = 0; NOT_UNUSED(jg); POINT_VARIABLES; 
#line 251 "/opt/basilisk/src/grid/multigrid-common.h"
  ...
  if (point.level > 0) {
    ...
    FILE * fp = fopen (name, "w");
#line 271 "/opt/basilisk/src/grid/multigrid-common.h"
...
#line 302 "/opt/basilisk/src/grid/multigrid-common.h"
    fclose (fp);
  }
  ...
  if (is_coarse()) {
    ...
    FILE * fp = fopen (name, "w");
#line 324 "/opt/basilisk/src/grid/multigrid-common.h"
...
#line 362 "/opt/basilisk/src/grid/multigrid-common.h"
    fclose (fp);
  }
  fflush (ferr);
  fclose (plot);
...
#line 389 "/opt/basilisk/src/grid/multigrid-common.h"
 {
...
#line 428 "/opt/basilisk/src/grid/multigrid-common.h"
...
#line 437 "/opt/basilisk/src/grid/multigrid-common.h"
 {
      double sum = !leaves;
       { foreach_child()
...
#line 5 "/opt/basilisk/src/grid/tree-common.h"
...
#line 21 "/opt/basilisk/src/grid/tree-common.h"
int refine_cell (Point point, scalar * list, int flag, Cache * refined)
{ int ig = 0; NOT_UNUSED(ig); int jg = 0; NOT_UNUSED(jg); POINT_VARIABLES; 
#line 22 "/opt/basilisk/src/grid/tree-common.h"
...
{ int ig = 0; NOT_UNUSED(ig); int jg = 0; NOT_UNUSED(jg); POINT_VARIABLES; 
#line 99 "/opt/basilisk/src/grid/tree-common.h"
...
{ int ig = 0; NOT_UNUSED(ig); int jg = 0; NOT_UNUSED(jg); POINT_VARIABLES; 
#line 137 "/opt/basilisk/src/grid/tree-common.h"
...
{ trace ("adapt_wavelet", "/opt/basilisk/src/grid/tree-common.h", 167);
  if (p.list == NULL)
    p.list = all;
  if (is_constant(cm))
    restriction (p.slist);
...
#line 189 "/opt/basilisk/src/grid/tree-common.h"
 {
    if (is_active(cell)) {
...
#line 261 "/opt/basilisk/src/grid/tree-common.h"
 ...
 if (level == l) {
  ...
  { astats _ret =  st; end_trace("adapt_wavelet", "/opt/basilisk/src/grid/tree-common.h", 292);  return _ret; }
 end_trace("adapt_wavelet", "/opt/basilisk/src/grid/tree-common.h", 293); }
#line 314 "/opt/basilisk/src/grid/tree-common.h"
static void refine_level (int depth)
{
  int refined;
  do {
...
#line 320 "/opt/basilisk/src/grid/tree-common.h"
...
#line 359 "/opt/basilisk/src/grid/tree-common.h"
...
#line 368 "/opt/basilisk/src/grid/tree-common.h"

 {
#line 369
 {
#line 378 "/opt/basilisk/src/grid/tree-common.h"
...
#line 394 "/opt/basilisk/src/grid/tree-common.h"
      }
#line 369
 {
#line 378 "/opt/basilisk/src/grid/tree-common.h"
...
{ int ig = 0; NOT_UNUSED(ig); int jg = 0; NOT_UNUSED(jg); POINT_VARIABLES; 
#line 409 "/opt/basilisk/src/grid/tree-common.h"
...
#line 441 "/opt/basilisk/src/grid/tree-common.h"
      }
#line 428
...
{ int ig = 0; NOT_UNUSED(ig); int jg = 0; NOT_UNUSED(jg); POINT_VARIABLES; 
#line 454 "/opt/basilisk/src/grid/tree-common.h"
...
#line 499 "/opt/basilisk/src/grid/tree-common.h"
}
#line 452
...
{ int ig = 0; NOT_UNUSED(ig); int jg = 0; NOT_UNUSED(jg); POINT_VARIABLES; 
#line 502 "/opt/basilisk/src/grid/tree-common.h"
...
{ int ig = 0; NOT_UNUSED(ig); int jg = 0; NOT_UNUSED(jg); POINT_VARIABLES; 
#line 509 "/opt/basilisk/src/grid/tree-common.h"
...
#line 559 "/opt/basilisk/src/grid/tree-common.h"
  }
...
#line 611 "/opt/basilisk/src/grid/tree-common.h"
 {
...
#line 660 "/opt/basilisk/src/grid/tree-common.h"
...
#line 665 "/opt/basilisk/src/grid/tree-common.h"
 {
...
#line 691 "/opt/basilisk/src/grid/tree-common.h"
 {
...
#line 705 "/opt/basilisk/src/grid/tree-common.h"
...
#line 718 "/opt/basilisk/src/grid/tree-common.h"
...
#line 726 "/opt/basilisk/src/grid/tree-common.h"
...
#line 739 "/opt/basilisk/src/grid/tree-common.h"
 {
    if (is_leaf(cell)) {
      assert (cell.pid >= 0);
      nleaves++;
...
#line 762 "/opt/basilisk/src/grid/tree-common.h"
 {
    if (is_active(cell))
      reachable++;
    else
...
#line 772 "/opt/basilisk/src/grid/tree-common.h"
...
#line 1789 "/opt/basilisk/src/grid/tree.h"
...
#line 1 "/opt/basilisk/src/grid/tree-mpi.h"
...
{ int ig = 0; NOT_UNUSED(ig); int jg = 0; NOT_UNUSED(jg); POINT_VARIABLES; 
#line 39 "/opt/basilisk/src/grid/tree-mpi.h"
...
#line 55 "/opt/basilisk/src/grid/tree-mpi.h"
...
{ int ig = 0; NOT_UNUSED(ig); int jg = 0; NOT_UNUSED(jg); POINT_VARIABLES; 
#line 108 "/opt/basilisk/src/grid/tree-mpi.h"
...
#line 165 "/opt/basilisk/src/grid/tree-mpi.h"
 {
...
#line 226 "/opt/basilisk/src/grid/tree-mpi.h"
static void mpi_recv_check (void * buf, int count, MPI_Datatype datatype,
       int source, int tag,
       MPI_Comm comm, MPI_Status * status,
       const char * name)
{
#line 261 "/opt/basilisk/src/grid/tree-mpi.h"
...
static int mpi_waitany (int count, MPI_Request array_of_requests[], int *indx,
   MPI_Status *status)
{ trace ("mpi_waitany", "/opt/basilisk/src/grid/tree-mpi.h", 285);
  { int _ret =  MPI_Waitany (count, array_of_requests, indx, status); end_trace("mpi_waitany", "/opt/basilisk/src/grid/tree-mpi.h", 286);  return _ret; }
 end_trace("mpi_waitany", "/opt/basilisk/src/grid/tree-mpi.h", 287); }
...
{ trace ("rcv_pid_wait", "/opt/basilisk/src/grid/tree-mpi.h", 345);

  for (int i = 0; i < m->npid; i++)
    rcv_free_buf (&m->rcv[i]);
 end_trace("rcv_pid_wait", "/opt/basilisk/src/grid/tree-mpi.h", 349); }
...
#line 369 "/opt/basilisk/src/grid/tree-mpi.h"
 {
...
{ trace ("mpi_boundary_level", "/opt/basilisk/src/grid/tree-mpi.h", 451);
  MpiBoundary * m = (MpiBoundary *) b;
  rcv_pid_sync (&m->mpi_level, list, l);
  rcv_pid_sync (&m->mpi_level_root, list, l);
 end_trace("mpi_boundary_level", "/opt/basilisk/src/grid/tree-mpi.h", 455); }


static void mpi_boundary_restriction (const Boundary * b, scalar * list, int l)
{ trace ("mpi_boundary_restriction", "/opt/basilisk/src/grid/tree-mpi.h", 459);
  MpiBoundary * m = (MpiBoundary *) b;
  rcv_pid_sync (&m->restriction, list, l);
 end_trace("mpi_boundary_restriction", "/opt/basilisk/src/grid/tree-mpi.h", 462); }
...
#line 526 "/opt/basilisk/src/grid/tree-mpi.h"
...
#line 539 "/opt/basilisk/src/grid/tree-mpi.h"
...
#line 545 "/opt/basilisk/src/grid/tree-mpi.h"
...
#line 551 "/opt/basilisk/src/grid/tree-mpi.h"
 {
    int n = 0;
     { foreach_neighbor(1)
      if ((!is_leaf (cell) && cell.neighbors && cell.pid >= 0))
...
#line 595 "/opt/basilisk/src/grid/tree-mpi.h"
 {
    if (is_border(cell))
...
#line 608 "/opt/basilisk/src/grid/tree-mpi.h"
 {
    if (!is_local(cell))
...
#line 637 "/opt/basilisk/src/grid/tree-mpi.h"
...
{ int ig = 0; NOT_UNUSED(ig); int jg = 0; NOT_UNUSED(jg); POINT_VARIABLES; 
#line 655 "/opt/basilisk/src/grid/tree-mpi.h"
...
{ int ig = 0; NOT_UNUSED(ig); int jg = 0; NOT_UNUSED(jg); POINT_VARIABLES; 
#line 665 "/opt/basilisk/src/grid/tree-mpi.h"
...
{ int ig = 0; NOT_UNUSED(ig); int jg = 0; NOT_UNUSED(jg); POINT_VARIABLES; 
#line 691 "/opt/basilisk/src/grid/tree-mpi.h"
...
{ int ig = 0; NOT_UNUSED(ig); int jg = 0; NOT_UNUSED(jg); POINT_VARIABLES; 
#line 719 "/opt/basilisk/src/grid/tree-mpi.h"
...
{ int ig = 0; NOT_UNUSED(ig); int jg = 0; NOT_UNUSED(jg); POINT_VARIABLES; 
#line 808 "/opt/basilisk/src/grid/tree-mpi.h"
...
{ trace ("mpi_boundary_update_buffers", "/opt/basilisk/src/grid/tree-mpi.h", 817);
  if (npe() == 1)
    { ; end_trace("mpi_boundary_update_buffers", "/opt/basilisk/src/grid/tree-mpi.h", 819);  return; }
...
#line 833 "/opt/basilisk/src/grid/tree-mpi.h"
 {
...
#line 938 "/opt/basilisk/src/grid/tree-mpi.h"
 ...
 continue;
  ...
  prof_stop();
#line 970 "/opt/basilisk/src/grid/tree-mpi.h"
 end_trace("mpi_boundary_update_buffers", "/opt/basilisk/src/grid/tree-mpi.h", 970); }


void mpi_boundary_refine (scalar * list)
{ trace ("mpi_boundary_refine", "/opt/basilisk/src/grid/tree-mpi.h", 974);
...
#line 1008 "/opt/basilisk/src/grid/tree-mpi.h"
 ...
 end_trace("mpi_boundary_refine", "/opt/basilisk/src/grid/tree-mpi.h", 1038); }

static void check_depth()
{
#line 1073 "/opt/basilisk/src/grid/tree-mpi.h"
}
...
{ trace ("mpi_boundary_coarsen", "/opt/basilisk/src/grid/tree-mpi.h", 1083);
  if (npe() == 1)
    { ; end_trace("mpi_boundary_coarsen", "/opt/basilisk/src/grid/tree-mpi.h", 1085);  return; }
...
#line 1092 "/opt/basilisk/src/grid/tree-mpi.h"
 {
    if (level == l) {
      if (is_local(cell)) {
...
#line 1109 "/opt/basilisk/src/grid/tree-mpi.h"
 {
    if (level == l) {
      if (!is_local(cell)) {
...
#line 1129 "/opt/basilisk/src/grid/tree-mpi.h"
 {
      if (level == l) {
...
#line 1138 "/opt/basilisk/src/grid/tree-mpi.h"
 {
      if (level == l)
 ...
 delete (((scalar []){remote,{-1}}));  end_trace("mpi_boundary_coarsen", "/opt/basilisk/src/grid/tree-mpi.h", 1148); }

static void flag_border_cells()
{
   { foreach_cell(){

#line 1152 "/opt/basilisk/src/grid/tree-mpi.h"
 {
    if (is_active(cell)) {
...
{ trace ("mpi_partitioning", "/opt/basilisk/src/grid/tree-mpi.h", 1203);
  prof_start ("mpi_partitioning");

  long nt = 0;
   { foreach(){

#line 1207 "/opt/basilisk/src/grid/tree-mpi.h"
...
#line 1213 "/opt/basilisk/src/grid/tree-mpi.h"
 ...
 end_trace("mpi_partitioning", "/opt/basilisk/src/grid/tree-mpi.h", 1241); }
...
#line 1252 "/opt/basilisk/src/grid/tree-mpi.h"
...
#line 1288 "/opt/basilisk/src/grid/tree-mpi.h"
 {
    unsigned flags;
    if (fread (&flags, sizeof(unsigned), 1, fp) != 1) {
      fprintf (ferr, "restore(): error: expecting 'flags'\n");
...
#line 1332 "/opt/basilisk/src/grid/tree-mpi.h"
 {
    cell.flags &= ~set;
    if (is_active (cell)) {
      if (is_leaf (cell)) {
...
#line 1381 "/opt/basilisk/src/grid/tree-mpi.h"

double z_indexing (scalar index, bool leaves)
{ trace ("z_indexing", "/opt/basilisk/src/grid/tree-mpi.h", 1383);
...
#line 1397 "/opt/basilisk/src/grid/tree-mpi.h"
...
#line 1403 "/opt/basilisk/src/grid/tree-mpi.h"
...
#line 1407 "/opt/basilisk/src/grid/tree-mpi.h"
 {
      if (level == l) {
 if (is_leaf(cell)) {
 ...
 continue;
  ...
  { double _ret =  maxi; delete (((scalar []){size,{-1}}));  end_trace("z_indexing", "/opt/basilisk/src/grid/tree-mpi.h", 1438);  return _ret; }
 delete (((scalar []){size,{-1}}));  end_trace("z_indexing", "/opt/basilisk/src/grid/tree-mpi.h", 1439); }
#line 1804 "/opt/basilisk/src/grid/tree.h"
#line 1 "grid/balance.h"
#line 1 "/opt/basilisk/src/grid/balance.h"
...
#line 21 "/opt/basilisk/src/grid/balance.h"
...
#line 26 "/opt/basilisk/src/grid/balance.h"
 {
    if (cell.flags & sent) {
...
#line 99 "/opt/basilisk/src/grid/balance.h"
 {
...
#line 156 "/opt/basilisk/src/grid/balance.h"
 {
...
bool balance()
{ trace ("balance", "/opt/basilisk/src/grid/balance.h", 201);
  if (npe() == 1)
    { bool _ret =  false; end_trace("balance", "/opt/basilisk/src/grid/balance.h", 203);  return _ret; }
...
#line 210 "/opt/basilisk/src/grid/balance.h"
 {
    if (is_local(cell)) {
      nt++;
      if (is_leaf(cell))
 nl++;
  ...
  if (nmax - nmin <= 1)
    { bool _ret =  false; end_trace("balance", "/opt/basilisk/src/grid/balance.h", 243);  return _ret; }
  ...
  FILE * fp = NULL;
#line 260 "/opt/basilisk/src/grid/balance.h"
  bool next = false, prev = false;
   { foreach_cell_all(){

#line 261 "/opt/basilisk/src/grid/balance.h"
 {
    if (is_local(cell)) {
...
#line 304 "/opt/basilisk/src/grid/balance.h"
...
#line 338 "/opt/basilisk/src/grid/balance.h"
 {
    if (cell.pid >= 0) {
      if (is_newpid()) {
 if (fp)
...
#line 370 "/opt/basilisk/src/grid/balance.h"
 ...
 cell.flags = flags;
  ...
  { bool _ret =  pid_changed; delete (((scalar []){newpid,{-1}}));  end_trace("balance", "/opt/basilisk/src/grid/balance.h", 390);  return _ret; }
 delete (((scalar []){newpid,{-1}}));  end_trace("balance", "/opt/basilisk/src/grid/balance.h", 391); }
...
#line 1805 "/opt/basilisk/src/grid/tree.h"
#else
void mpi_boundary_refine (scalar * list){}
...
#endif
#line 4 "/opt/basilisk/src/grid/quadtree.h"
...
#line 1 "/opt/basilisk/src/navier-stokes/centered.h"
#line 27 "/opt/basilisk/src/navier-stokes/centered.h"
#line 1 "./run.h"
#line 1 "/opt/basilisk/src/run.h"
#line 9 "/opt/basilisk/src/run.h"
double dt = 1.;

#line 1 "./utils.h"
#line 1 "/opt/basilisk/src/utils.h"
...
#line 69 "/opt/basilisk/src/utils.h"
...
#line 136 "/opt/basilisk/src/utils.h"
...
#line 164 "/opt/basilisk/src/utils.h"
...
#line 187 "/opt/basilisk/src/utils.h"
...
#line 213 "/opt/basilisk/src/utils.h"
double theta = 1.3;
...
#line 237 "/opt/basilisk/src/utils.h"
void gradients (scalar * f, vector * g)
{
  assert (list_len(f) == vectors_len(g));
   { foreach(){

#line 240 "/opt/basilisk/src/utils.h"
 {
    scalar s; vector v;
...
#line 275 "/opt/basilisk/src/utils.h"
void vorticity (const vector u, scalar omega)
{
  struct { double x, y; } a = {1., -1.};
   { foreach(){

#line 278 "/opt/basilisk/src/utils.h"
 {
    val(omega,0,0,0) = 0.;
    {
#line 280
...
#line 293 "/opt/basilisk/src/utils.h"
 {
...
#line 1 "./output.h"
#line 1 "/opt/basilisk/src/output.h"
#line 37 "/opt/basilisk/src/output.h"
struct OutputField {
  scalar * list;
  FILE * fp;
  int n;
...
{ trace ("output_field", "/opt/basilisk/src/output.h", 47);
...
#line 72 "/opt/basilisk/src/output.h"
 ...
 fputc ('\n', p.fp);
  ...
  matrix_free (field);
 end_trace("output_field", "/opt/basilisk/src/output.h", 112); }
#line 140 "/opt/basilisk/src/output.h"
struct OutputMatrix {
  scalar f;
  FILE * fp;
  int n;
...
{ trace ("output_matrix", "/opt/basilisk/src/output.h", 149);
  if (p.n == 0) p.n = N;
  if (!p.fp) p.fp = fout;
  float fn = p.n;
...
#line 167 "/opt/basilisk/src/output.h"
 ...
 v = val(p.f,0,0,0);
  ...
  fflush (p.fp);
 end_trace("output_matrix", "/opt/basilisk/src/output.h", 175); }
#line 184 "/opt/basilisk/src/output.h"
...
#line 321 "/opt/basilisk/src/output.h"
...
#line 552 "/opt/basilisk/src/output.h"
struct OutputPPM {
  scalar f;
  FILE * fp;
  int n;
...
{ trace ("output_ppm", "/opt/basilisk/src/output.h", 567);
...
#line 610 "/opt/basilisk/src/output.h"
  ...
  v = val(p.f,0,0,0);
     ...
     Point point = locate ((struct _locate){xp, yp, p.z});  int ig = 0; NOT_UNUSED(ig); int jg = 0; NOT_UNUSED(jg); POINT_VARIABLES; 
#line 620 "/opt/basilisk/src/output.h"
  ...
  matrix_free (ppm);
 end_trace("output_ppm", "/opt/basilisk/src/output.h", 652); }
#line 684 "/opt/basilisk/src/output.h"
struct OutputGRD {
  scalar f;
  FILE * fp;
  double Delta;
...
{ trace ("output_grd", "/opt/basilisk/src/output.h", 695);
 ...
 if (p.linear) {
   ...
   Point point = locate ((struct _locate){xp, yp});  int ig = 0; NOT_UNUSED(ig); int jg = 0; NOT_UNUSED(jg); POINT_VARIABLES; 
#line 731 "/opt/basilisk/src/output.h"
 ...
 Point point = locate ((struct _locate){xp, yp});  int ig = 0; NOT_UNUSED(ig); int jg = 0; NOT_UNUSED(jg); POINT_VARIABLES; 
#line 741 "/opt/basilisk/src/output.h"
 ...
 fprintf (p.fp, "%f ", v);
  ...
  fflush (p.fp);
 end_trace("output_grd", "/opt/basilisk/src/output.h", 753); }
#line 780 "/opt/basilisk/src/output.h"
struct OutputGfs {
  FILE * fp;
  scalar * list;
  double t;
...
{ trace ("output_gfs", "/opt/basilisk/src/output.h", 810);
  char * fname = p.file;
...
#line 888 "/opt/basilisk/src/output.h"
 {
#if _MPI
    if (is_local(cell))
#endif
 ...
 3;
#line 918 "/opt/basilisk/src/output.h"
      if (is_leaf(cell))
 flags |= (1 << 4);
...
#endif
 end_trace("output_gfs", "/opt/basilisk/src/output.h", 986); }
#line 1010 "/opt/basilisk/src/output.h"
struct Dump {
  char * file;
  scalar * list;
  FILE * fp;
...
{ trace ("dump", "/opt/basilisk/src/output.h", 1064);
  FILE * fp = p.fp;
...
#line 1090 "/opt/basilisk/src/output.h"
 {
 ...
 delete (((scalar []){size,{-1}}));  end_trace("dump", "/opt/basilisk/src/output.h", 1112); }
#else

void dump (struct Dump p)
{ trace ("dump", "/opt/basilisk/src/output.h", 1116);
  FILE * fp = p.fp;
  char def[] = "dump", * file = p.file ? p.file : p.fp ? NULL : def;
...
#line 1162 "/opt/basilisk/src/output.h"
 {
 ...
 fwrite (&val(s,0,0,0), 1, sizeof(double), fh);
  ...
  if (!p.unbuffered && pid() == 0)
    rename (name, file);
 delete (((scalar []){size,{-1}}));  end_trace("dump", "/opt/basilisk/src/output.h", 1186); }
#endif


bool restore (struct Dump p)
{ trace ("restore", "/opt/basilisk/src/output.h", 1191);
  FILE * fp = p.fp;
  char * file = p.file;
  if (file && (fp = fopen (file, "r")) == NULL)
    { bool _ret =  false; end_trace("restore", "/opt/basilisk/src/output.h", 1195);  return _ret; }
  assert (fp);
...
#line 1206 "/opt/basilisk/src/output.h"
 {
    cell.pid = pid();
    cell.flags |= active;
  } } end_foreach_cell(); }
  ((Tree *)grid)->dirty = true;
#line 1231 "/opt/basilisk/src/output.h"
...
#line 1306 "/opt/basilisk/src/output.h"
  scalar * listm = is_constant(cm) ? NULL : (scalar *)((vector []){{fm.x,fm.y},{{-1},{-1}}});
...
#line 1310 "/opt/basilisk/src/output.h"
 {
    unsigned flags;
    if (fread (&flags, sizeof(unsigned), 1, fp) != 1) {
      fprintf (ferr, "restore(): error: expecting 'flags'\n");
 ...
 val(s,0,0,0) = val;
  ...
  { bool _ret =  true; end_trace("restore", "/opt/basilisk/src/output.h", 1356);  return _ret; }
 end_trace("restore", "/opt/basilisk/src/output.h", 1357); }
#line 366 "/opt/basilisk/src/utils.h"
#line 12 "/opt/basilisk/src/run.h"


void run (void)
{ trace ("run", "/opt/basilisk/src/run.h", 15);
  iter = 0, t = 0., dt = 1.;
  init_grid (N);
  ...
  free_grid();
 end_trace("run", "/opt/basilisk/src/run.h", 37); }




static int defaults_expr0 (int * ip, double * tp, Event * _ev) {  int i = *ip; double t = *tp;  int ret = (i = 0);   *ip = i; *tp = t;   return ret; } static int defaults (const int i, const double t, Event * _ev) { trace ("defaults", "/opt/basilisk/src/run.h", 42);  {
  display ((struct _display){"box();"});
 end_trace("defaults", "/opt/basilisk/src/run.h", 44); } return 0; } 





static int cleanup_expr0 (int * ip, double * tp, Event * _ev) {  int i = *ip; double t = *tp;  int ret = (t = 1234567890);   *ip = i; *tp = t;   return ret; } static int cleanup (const int i, const double t, Event * _ev) { trace ("cleanup", "/opt/basilisk/src/run.h", 50);  {
  display ((struct _display){"", true});
 end_trace("cleanup", "/opt/basilisk/src/run.h", 52); } return 0; } 
#line 28 "/opt/basilisk/src/navier-stokes/centered.h"
#line 1 "./timestep.h"
#line 1 "/opt/basilisk/src/timestep.h"
...
#line 6 "/opt/basilisk/src/timestep.h"
...
#line 29 "/opt/basilisk/src/navier-stokes/centered.h"
#line 1 "./bcg.h"
#line 1 "/opt/basilisk/src/bcg.h"
#line 11 "/opt/basilisk/src/bcg.h"
...
#line 28 "/opt/basilisk/src/bcg.h"
 {
...
#line 58 "/opt/basilisk/src/bcg.h"
...
#line 99 "/opt/basilisk/src/bcg.h"
...
#line 30 "/opt/basilisk/src/navier-stokes/centered.h"



#line 1 "./viscosity.h"
#line 1 "/opt/basilisk/src/viscosity.h"
#line 1 "./poisson.h"
#line 1 "/opt/basilisk/src/poisson.h"
#line 32 "/opt/basilisk/src/poisson.h"
...
#line 55 "/opt/basilisk/src/poisson.h"
...
#line 65 "/opt/basilisk/src/poisson.h"
...
#line 84 "/opt/basilisk/src/poisson.h"
 {
    scalar s, ds;
...
#line 103 "/opt/basilisk/src/poisson.h"
...
#line 126 "/opt/basilisk/src/poisson.h"
struct MGSolve {
  scalar * a, * b;
...
#line 165 "/opt/basilisk/src/poisson.h"

    if (p.b) for (scalar s = *p.b, *_i88 = p.b; ((scalar *)&s)->i >= 0; s = *++_i88)
...
#line 200 "/opt/basilisk/src/poisson.h"
    if (s.resa > TOLERANCE) {
...
#line 263 "/opt/basilisk/src/poisson.h"
struct Poisson {
  scalar a, b;
   vector alpha;
   scalar lambda;
...
#line 301 "/opt/basilisk/src/poisson.h"
  scalar c = a;
...
#line 308 "/opt/basilisk/src/poisson.h"
 {
...
#line 324 "/opt/basilisk/src/poisson.h"
      val(c,0,0,0) = n/d;
...
#line 343 "/opt/basilisk/src/poisson.h"
}
...
#line 360 "/opt/basilisk/src/poisson.h"
...
#line 363 "/opt/basilisk/src/poisson.h"
 {
...
#line 393 "/opt/basilisk/src/poisson.h"
  boundary (resl);
  { double _ret =  maxres; delete (((scalar []){g.x,g.y,{-1}}));  return _ret; }
 delete (((scalar []){g.x,g.y,{-1}})); }
#line 406 "/opt/basilisk/src/poisson.h"
...
#line 468 "/opt/basilisk/src/poisson.h"
struct Project {
  vector uf;
  scalar p;
  vector alpha;
...
{ trace ("project", "/opt/basilisk/src/poisson.h", 478);
  vector uf = q.uf;
  scalar p = q.p;
...
#line 491 "/opt/basilisk/src/poisson.h"
 {
    val(div,0,0,0) = 0.;
    {
#line 493
...
#line 507 "/opt/basilisk/src/poisson.h"
...
#line 513 "/opt/basilisk/src/poisson.h"
...
#line 514
 end_foreach_face(); } }
  ...
  { mgstats _ret =  mgp; delete (((scalar []){div,{-1}}));  end_trace("project", "/opt/basilisk/src/poisson.h", 517);  return _ret; }
 delete (((scalar []){div,{-1}}));  end_trace("project", "/opt/basilisk/src/poisson.h", 518); }
#line 2 "/opt/basilisk/src/viscosity.h"
...
#line 25 "/opt/basilisk/src/viscosity.h"
...
#line 39 "/opt/basilisk/src/viscosity.h"
 {
    {
#line 40
     ...
     (val(u.y,-1,0,0) + val(u.y,-1,1,0))/4.)
      - val_mu_y(mu.y,0,0,0)*(- val(u.x,0,-1,0) +
         ...
         (val(u.y,-1,-1,0) + val(u.y,-1,0,0))/4.)
#line 58 "/opt/basilisk/src/viscosity.h"
...
#line 85 "/opt/basilisk/src/viscosity.h"
}
...
#line 100 "/opt/basilisk/src/viscosity.h"
...
#line 103 "/opt/basilisk/src/viscosity.h"
...
#line 115 "/opt/basilisk/src/viscosity.h"
 {
      double d = 0.;
      {
#line 117
...
#line 122
   ...
   delete (((scalar []){taux.x,taux.y,{-1}})); }}
  boundary (resl);
#line 153 "/opt/basilisk/src/viscosity.h"
  return maxres;
}
...
{ trace ("viscosity", "/opt/basilisk/src/viscosity.h", 160);
  vector u = p.u, r= new_vector("r");
   { foreach(){

#line 162 "/opt/basilisk/src/viscosity.h"
...
#line 163
  ...
  { mgstats _ret =  mg_solve ((struct MGSolve){(scalar *)((vector []){{u.x,u.y},{{-1},{-1}}}), (scalar *)((vector []){{r.x,r.y},{{-1},{-1}}}),
     residual_viscosity, relax_viscosity, &p, p.nrelax, p.res}); delete (((scalar []){r.x,r.y,{-1}}));  end_trace("viscosity", "/opt/basilisk/src/viscosity.h", 171);  return _ret; }
 delete (((scalar []){r.x,r.y,{-1}}));  end_trace("viscosity", "/opt/basilisk/src/viscosity.h", 172); }


mgstats viscosity_explicit (struct Viscosity p)
{ trace ("viscosity_explicit", "/opt/basilisk/src/viscosity.h", 176);
  vector u = p.u, r= new_vector("r");
  mgstats mg = {0};
  mg.resb = residual_viscosity ((scalar *)((vector []){{u.x,u.y},{{-1},{-1}}}), (scalar *)((vector []){{u.x,u.y},{{-1},{-1}}}), (scalar *)((vector []){{r.x,r.y},{{-1},{-1}}}), &p);
   { foreach(){

#line 180 "/opt/basilisk/src/viscosity.h"
...
#line 181
  ...
  { mgstats _ret =  mg; delete (((scalar []){r.x,r.y,{-1}}));  end_trace("viscosity_explicit", "/opt/basilisk/src/viscosity.h", 184);  return _ret; }
 delete (((scalar []){r.x,r.y,{-1}}));  end_trace("viscosity_explicit", "/opt/basilisk/src/viscosity.h", 185); }
#line 34 "/opt/basilisk/src/navier-stokes/centered.h"
#line 44 "/opt/basilisk/src/navier-stokes/centered.h"
scalar p= {0};
vector u= {{1},{2}}, g= {{3},{4}};
scalar pf= {5};
vector uf= {{6},{7}};
#line 70 "/opt/basilisk/src/navier-stokes/centered.h"
...
#line 126 "/opt/basilisk/src/navier-stokes/centered.h"
static int defaults_0_expr0 (int * ip, double * tp, Event * _ev) {  int i = *ip; double t = *tp;  int ret = (i = 0);   *ip = i; *tp = t;   return ret; } static int defaults_0 (const int i, const double t, Event * _ev) { trace ("defaults_0", "/opt/basilisk/src/navier-stokes/centered.h", 126); 
{
...
#line 145 "/opt/basilisk/src/navier-stokes/centered.h"
...
#line 173 "/opt/basilisk/src/navier-stokes/centered.h"
 end_trace("defaults_0", "/opt/basilisk/src/navier-stokes/centered.h", 173); } return 0; } 





static int default_display_expr0 (int * ip, double * tp, Event * _ev) {  int i = *ip; double t = *tp;  int ret = (i = 0);   *ip = i; *tp = t;   return ret; } static int default_display (const int i, const double t, Event * _ev) { trace ("default_display", "/opt/basilisk/src/navier-stokes/centered.h", 179); 
  display ((struct _display){"squares (color = 'u.x', spread = -1);"}); end_trace("default_display", "/opt/basilisk/src/navier-stokes/centered.h", 180);  return 0; } 
...
static int init_expr0 (int * ip, double * tp, Event * _ev) {  int i = *ip; double t = *tp;  int ret = (i = 0);   *ip = i; *tp = t;   return ret; } static int init (const int i, const double t, Event * _ev) { trace ("init", "/opt/basilisk/src/navier-stokes/centered.h", 188); 
{
  boundary ((scalar *)((vector []){{u.x,u.y},{{-1},{-1}}}));
...
#line 192 "/opt/basilisk/src/navier-stokes/centered.h"
...
#line 193
 end_foreach_face(); } }
  ...
  dtmax = DT;
  event ("stability");
 end_trace("init", "/opt/basilisk/src/navier-stokes/centered.h", 207); } return 0; } 
#line 216 "/opt/basilisk/src/navier-stokes/centered.h"
static int set_dtmax_expr0 (int * ip, double * tp, Event * _ev) {  int i = *ip; double t = *tp;  int ret = (i++);   *ip = i; *tp = t;   return ret; } static int set_dtmax (const int i, const double t, Event * _ev) { trace ("set_dtmax", "/opt/basilisk/src/navier-stokes/centered.h", 216);  dtmax = DT; end_trace("set_dtmax", "/opt/basilisk/src/navier-stokes/centered.h", 216);  return 0; } 

static int stability_expr0 (int * ip, double * tp, Event * _ev) {  int i = *ip; double t = *tp;  int ret = (i++);   *ip = i; *tp = t;   return ret; } static int stability (const int i, const double t, Event * _ev) { trace ("stability", "/opt/basilisk/src/navier-stokes/centered.h", 218);  {
  dt = dtnext (stokes ? dtmax : timestep (uf, dtmax));
 end_trace("stability", "/opt/basilisk/src/navier-stokes/centered.h", 220); } return 0; } 
...
static int vof_expr0 (int * ip, double * tp, Event * _ev) {  int i = *ip; double t = *tp;  int ret = (i++);   *ip = i; *tp = t;   return ret; } static int vof (const int i, const double t, Event * _ev) { trace ("vof", "/opt/basilisk/src/navier-stokes/centered.h", 228); ; end_trace("vof", "/opt/basilisk/src/navier-stokes/centered.h", 228);  return 0; } 
static int tracer_advection_expr0 (int * ip, double * tp, Event * _ev) {  int i = *ip; double t = *tp;  int ret = (i++);   *ip = i; *tp = t;   return ret; } static int tracer_advection (const int i, const double t, Event * _ev) { trace ("tracer_advection", "/opt/basilisk/src/navier-stokes/centered.h", 229); ; end_trace("tracer_advection", "/opt/basilisk/src/navier-stokes/centered.h", 229);  return 0; } 
static int tracer_diffusion_expr0 (int * ip, double * tp, Event * _ev) {  int i = *ip; double t = *tp;  int ret = (i++);   *ip = i; *tp = t;   return ret; } static int tracer_diffusion (const int i, const double t, Event * _ev) { trace ("tracer_diffusion", "/opt/basilisk/src/navier-stokes/centered.h", 230); ; end_trace("tracer_diffusion", "/opt/basilisk/src/navier-stokes/centered.h", 230);  return 0; } 
...
static int properties_expr0 (int * ip, double * tp, Event * _ev) {  int i = *ip; double t = *tp;  int ret = (i++);   *ip = i; *tp = t;   return ret; } static int properties (const int i, const double t, Event * _ev) { trace ("properties", "/opt/basilisk/src/navier-stokes/centered.h", 237);  {
  boundary (((scalar []){alpha.x,alpha.y,mu.x,mu.y,rho,{-1}}));
 end_trace("properties", "/opt/basilisk/src/navier-stokes/centered.h", 239); } return 0; } 
#line 251 "/opt/basilisk/src/navier-stokes/centered.h"
void prediction()
{
  vector du;
  {
...
#line 260 "/opt/basilisk/src/navier-stokes/centered.h"
...
#line 270 "/opt/basilisk/src/navier-stokes/centered.h"
...
#line 282 "/opt/basilisk/src/navier-stokes/centered.h"
 {
...
#line 314 "/opt/basilisk/src/navier-stokes/centered.h"
static int advection_term_expr0 (int * ip, double * tp, Event * _ev) {  int i = *ip; double t = *tp;  int ret = (i++);   *ip = i; *tp = t;   return ret; } static int advection_term (const int i, const double t, Event * _ev) { trace ("advection_term", "/opt/basilisk/src/navier-stokes/centered.h", 314); 
{
  if (!stokes) {
    prediction();
 ...
 end_trace("advection_term", "/opt/basilisk/src/navier-stokes/centered.h", 321); } return 0; } 
...
#line 331 "/opt/basilisk/src/navier-stokes/centered.h"
...
#line 344 "/opt/basilisk/src/navier-stokes/centered.h"
static int viscous_term_expr0 (int * ip, double * tp, Event * _ev) {  int i = *ip; double t = *tp;  int ret = (i++);   *ip = i; *tp = t;   return ret; } static int viscous_term (const int i, const double t, Event * _ev) { trace ("viscous_term", "/opt/basilisk/src/navier-stokes/centered.h", 344); 
{
  if (constant(mu.x) != 0.) {
    correction (dt);
...
#line 358 "/opt/basilisk/src/navier-stokes/centered.h"
...
#line 359
 ...
 end_trace("viscous_term", "/opt/basilisk/src/navier-stokes/centered.h", 361); } return 0; } 
#line 380 "/opt/basilisk/src/navier-stokes/centered.h"
static int acceleration_expr0 (int * ip, double * tp, Event * _ev) {  int i = *ip; double t = *tp;  int ret = (i++);   *ip = i; *tp = t;   return ret; } static int acceleration (const int i, const double t, Event * _ev) { trace ("acceleration", "/opt/basilisk/src/navier-stokes/centered.h", 380); 
{
  trash (((vector []){{uf.x,uf.y},{{-1},{-1}}}));
   { 
...
#line 383 "/opt/basilisk/src/navier-stokes/centered.h"
...
#line 384
 ...
 end_trace("acceleration", "/opt/basilisk/src/navier-stokes/centered.h", 386); } return 0; } 
#line 395 "/opt/basilisk/src/navier-stokes/centered.h"
...
#line 403 "/opt/basilisk/src/navier-stokes/centered.h"
...
#line 412 "/opt/basilisk/src/navier-stokes/centered.h"
...
static int projection_expr0 (int * ip, double * tp, Event * _ev) {  int i = *ip; double t = *tp;  int ret = (i++);   *ip = i; *tp = t;   return ret; } static int projection (const int i, const double t, Event * _ev) { trace ("projection", "/opt/basilisk/src/navier-stokes/centered.h", 423); 
{
  ...
  correction (dt);
 end_trace("projection", "/opt/basilisk/src/navier-stokes/centered.h", 432); } return 0; } 





static int end_timestep_expr0 (int * ip, double * tp, Event * _ev) {  int i = *ip; double t = *tp;  int ret = (i++);   *ip = i; *tp = t;   return ret; } static int end_timestep (const int i, const double t, Event * _ev) { trace ("end_timestep", "/opt/basilisk/src/navier-stokes/centered.h", 438); ; end_trace("end_timestep", "/opt/basilisk/src/navier-stokes/centered.h", 438);  return 0; } 
#line 448 "/opt/basilisk/src/navier-stokes/centered.h"
static int adapt_expr0 (int * ip, double * tp, Event * _ev) {  int i = *ip; double t = *tp;  int ret = (i++);   *ip = i; *tp = t;   return ret; } static int adapt (const int i, const double t, Event * _ev) { trace ("adapt", "/opt/basilisk/src/navier-stokes/centered.h", 448);  {
  ...
  event ("properties");
 end_trace("adapt", "/opt/basilisk/src/navier-stokes/centered.h", 457); } return 0; } 
#line 12 "test.c"
#line 1 "two-phase.h"
#line 1 "/opt/basilisk/src/two-phase.h"
#line 13 "/opt/basilisk/src/two-phase.h"
#line 1 "vof.h"
#line 1 "/opt/basilisk/src/vof.h"
#line 27 "/opt/basilisk/src/vof.h"
...
#line 1 "fractions.h"
#line 1 "/opt/basilisk/src/fractions.h"
#line 12 "/opt/basilisk/src/fractions.h"
#line 1 "geometry.h"
#line 1 "/opt/basilisk/src/geometry.h"
#line 28 "/opt/basilisk/src/geometry.h"
...
#line 133 "/opt/basilisk/src/geometry.h"
...
#line 237 "/opt/basilisk/src/geometry.h"
...
#line 262 "/opt/basilisk/src/geometry.h"
...
#line 352 "/opt/basilisk/src/geometry.h"
...
#line 482 "/opt/basilisk/src/geometry.h"
...
#line 13 "/opt/basilisk/src/fractions.h"
...
#line 1 "myc2d.h"
#line 1 "/opt/basilisk/src/myc2d.h"
...
{ int ig = 0; NOT_UNUSED(ig); int jg = 0; NOT_UNUSED(jg); POINT_VARIABLES; 
#line 7 "/opt/basilisk/src/myc2d.h"
...
#line 20 "/opt/basilisk/src/fractions.h"
#line 41 "/opt/basilisk/src/fractions.h"
void fraction_refine (Point point, scalar c)
{ int ig = 0; NOT_UNUSED(ig); int jg = 0; NOT_UNUSED(jg); POINT_VARIABLES; 
#line 42 "/opt/basilisk/src/fractions.h"
...
{ int ig = 0; NOT_UNUSED(ig); int jg = 0; NOT_UNUSED(jg); POINT_VARIABLES; 
#line 86 "/opt/basilisk/src/fractions.h"
...
#line 121 "/opt/basilisk/src/fractions.h"
struct Fractions {
  scalar Phi;
  scalar c;
  vector s;
...
{ trace ("fractions", "/opt/basilisk/src/fractions.h", 130);
  scalar Phi = a.Phi;
  scalar c = a.c;
  vector s = (a.s).x.i ? (a.s) : new_face_vector("s");
  double val = a.val;
#line 145 "/opt/basilisk/src/fractions.h"
  vector p;
  p.x = s.y; p.y = s.x;
#line 155 "/opt/basilisk/src/fractions.h"
   { foreach_face_generic() { int jg = -1; VARIABLES;  if (is_face_y()) {
#line 155
{
...
#line 180 "/opt/basilisk/src/fractions.h"
    else
...
#line 182
 end_foreach_face(); }
#line 197 "/opt/basilisk/src/fractions.h"
  boundary_flux (((vector []){{s.x,s.y},{{-1},{-1}}}));
  scalar s_z = c;
   { foreach(){

#line 199 "/opt/basilisk/src/fractions.h"


  {
#line 233 "/opt/basilisk/src/fractions.h"
    coord n;
    double nn = 0.;
    {
#line 235
...
#line 276 "/opt/basilisk/src/fractions.h"
      if (ni == 0)
...
#line 345 "/opt/basilisk/src/fractions.h"
  boundary (((scalar []){c,{-1}}));
 { if (!(a.s).x.i) delete (((scalar []){s.x,s.y,{-1}})); }  end_trace("fractions", "/opt/basilisk/src/fractions.h", 346); }
#line 384 "/opt/basilisk/src/fractions.h"
coord youngs_normal (Point point, scalar c)
{ int ig = 0; NOT_UNUSED(ig); int jg = 0; NOT_UNUSED(jg); POINT_VARIABLES; 
#line 385 "/opt/basilisk/src/fractions.h"
...
{ int ig = 0; NOT_UNUSED(ig); int jg = 0; NOT_UNUSED(jg); POINT_VARIABLES; 
#line 408 "/opt/basilisk/src/fractions.h"
...
#line 434 "/opt/basilisk/src/fractions.h"

void reconstruction (const scalar c, vector n, scalar alpha)
{ trace ("reconstruction", "/opt/basilisk/src/fractions.h", 436);
   { foreach(){

#line 437 "/opt/basilisk/src/fractions.h"
 {
...
#line 469 "/opt/basilisk/src/fractions.h"
  {
#line 469
...
#line 469
 ...
 end_trace("reconstruction", "/opt/basilisk/src/fractions.h", 485); }
#line 505 "/opt/basilisk/src/fractions.h"
struct OutputFacets {
  scalar c;
  FILE * fp;
  vector s;
...
{ trace ("output_facets", "/opt/basilisk/src/fractions.h", 513);
  scalar c = p.c;
  vector s = p.s;
  if (!p.fp) p.fp = fout;
  if (!s.x.i) s.x.i = -1;
...
#line 519 "/opt/basilisk/src/fractions.h"
...
#line 538 "/opt/basilisk/src/fractions.h"
    } } end_foreach(); }

  fflush (p.fp);
 end_trace("output_facets", "/opt/basilisk/src/fractions.h", 541); }
...
{ trace ("interface_area", "/opt/basilisk/src/fractions.h", 551);
  double area = 0.;
   { 
#undef OMP_PARALLEL
#define OMP_PARALLEL()
...
#line 553 "/opt/basilisk/src/fractions.h"
...
#line 558
  ...
  { double _ret =  area; end_trace("interface_area", "/opt/basilisk/src/fractions.h", 559);  return _ret; }
 end_trace("interface_area", "/opt/basilisk/src/fractions.h", 560); }
#line 36 "/opt/basilisk/src/vof.h"
#line 44 "/opt/basilisk/src/vof.h"
...
{ int ig = 0; NOT_UNUSED(ig); int jg = 0; NOT_UNUSED(jg); POINT_VARIABLES; 
#line 56 "/opt/basilisk/src/vof.h"
...
{ int ig = 0; NOT_UNUSED(ig); int jg = 0; NOT_UNUSED(jg); POINT_VARIABLES; 
#line 84 "/opt/basilisk/src/vof.h"
...
#line 84
  ...
  if ((!_attribute[s.i].inverse && val(f,0,0,0) <= 0.) || (_attribute[s.i].inverse && val(f,0,0,0) >= 1.))
     { foreach_child()
...
static int defaults_1_expr0 (int * ip, double * tp, Event * _ev) {  int i = *ip; double t = *tp;  int ret = (i = 0);   *ip = i; *tp = t;   return ret; } static int defaults_1 (const int i, const double t, Event * _ev) { trace ("defaults_1", "/opt/basilisk/src/vof.h", 107); 
{
  if (interfaces) for (scalar c = *interfaces, *_i89 = interfaces; ((scalar *)&c)->i >= 0; c = *++_i89) {
    _attribute[c.i].refine = _attribute[c.i].prolongation = fraction_refine;
    scalar * tracers = _attribute[c.i].tracers;
    if (tracers) for (scalar t = *tracers, *_i90 = tracers; ((scalar *)&t)->i >= 0; t = *++_i90) {
 ...
 end_trace("defaults_1", "/opt/basilisk/src/vof.h", 118); } return 0; } 
...
static int stability_0_expr0 (int * ip, double * tp, Event * _ev) {  int i = *ip; double t = *tp;  int ret = (i++);   *ip = i; *tp = t;   return ret; } static int stability_0 (const int i, const double t, Event * _ev) { trace ("stability_0", "/opt/basilisk/src/vof.h", 125);  {
  if (CFL > 0.5)
    CFL = 0.5;
 end_trace("stability_0", "/opt/basilisk/src/vof.h", 128); } return 0; } 
#line 142 "/opt/basilisk/src/vof.h"
...
static void sweep_x (scalar c, scalar cc, scalar * tcl)
{
  ...
  double cfl = 0.;
#line 156 "/opt/basilisk/src/vof.h"
...
#line 167 "/opt/basilisk/src/vof.h"
 {
      scalar t, gf;
...
#line 182 "/opt/basilisk/src/vof.h"
 {
...
#line 209 "/opt/basilisk/src/vof.h"
...
#line 248 "/opt/basilisk/src/vof.h"
  scalar * fluxl = list_concat (NULL, tfluxl);
  fluxl = list_append (fluxl, flux);
  for (int l = depth() - 1; l >= 0; l--)
     { foreach_halo (prolongation, l){

#line 251 "/opt/basilisk/src/vof.h"
 {
#line 260 "/opt/basilisk/src/vof.h"
      if ((!is_leaf (neighbor(-1,0,0)) && neighbor(-1,0,0).neighbors && neighbor(-1,0,0).pid >= 0))
...
#line 276 "/opt/basilisk/src/vof.h"
    } } end_foreach_halo(); }
  ...
  if (cfl > 0.5 + 1e-6)
    fprintf (ferr,
      ...
      cfl - 0.5), fflush (ferr);
#line 305 "/opt/basilisk/src/vof.h"
   { 
if (!is_constant(cm)) {
#undef val_cm
#define val_cm(a,i,j,k) val(a,i,j,k)
...
#line 335 "/opt/basilisk/src/vof.h"
    scalar cc= new_scalar("cc"), * tcl = NULL, * tracers = _attribute[c.i].tracers;
    if (tracers) for (scalar t = *tracers, *_i95 = tracers; ((scalar *)&t)->i >= 0; t = *++_i95) {
...
#line 345 "/opt/basilisk/src/vof.h"
 {
...
static int vof_0_expr0 (int * ip, double * tp, Event * _ev) {  int i = *ip; double t = *tp;  int ret = (i++);   *ip = i; *tp = t;   return ret; } static int vof_0 (const int i, const double t, Event * _ev) { trace ("vof_0", "/opt/basilisk/src/vof.h", 371); 
  vof_advection (interfaces, i); end_trace("vof_0", "/opt/basilisk/src/vof.h", 372);  return 0; } 
#line 14 "/opt/basilisk/src/two-phase.h"
...
static int defaults_2_expr0 (int * ip, double * tp, Event * _ev) {  int i = *ip; double t = *tp;  int ret = (i = 0);   *ip = i; *tp = t;   return ret; } static int defaults_2 (const int i, const double t, Event * _ev) { trace ("defaults_2", "/opt/basilisk/src/two-phase.h", 25);  {
  alpha = alphav;
  rho = rhov;
 ...
 end_trace("defaults_2", "/opt/basilisk/src/two-phase.h", 40); } return 0; } 
#line 59 "/opt/basilisk/src/two-phase.h"
scalar sf= {12};




static int tracer_advection_0_expr0 (int * ip, double * tp, Event * _ev) {  int i = *ip; double t = *tp;  int ret = (i++);   *ip = i; *tp = t;   return ret; } static int tracer_advection_0 (const int i, const double t, Event * _ev) { trace ("tracer_advection_0", "/opt/basilisk/src/two-phase.h", 64); 
{
...
#line 73 "/opt/basilisk/src/two-phase.h"
...
#line 90 "/opt/basilisk/src/two-phase.h"
  _attribute[sf.i].prolongation = refine_bilinear;
  boundary (((scalar []){sf,{-1}}));

 end_trace("tracer_advection_0", "/opt/basilisk/src/two-phase.h", 93); } return 0; } 

static int properties_0_expr0 (int * ip, double * tp, Event * _ev) {  int i = *ip; double t = *tp;  int ret = (i++);   *ip = i; *tp = t;   return ret; } static int properties_0 (const int i, const double t, Event * _ev) { trace ("properties_0", "/opt/basilisk/src/two-phase.h", 95); 
{
   { 
if (!is_constant(fm.x)) {
#undef val_fm_x
...
#line 97 "/opt/basilisk/src/two-phase.h"
 {
    double ff = (val(sf,0,0,0) + val(sf,-1,0,0))/2.;
    val(alphav.x,0,0,0) = val_fm_x(fm.x,0,0,0)/(clamp(ff,0.,1.)*(rho1 - rho2) + rho2);
    if (mu1 || mu2) {
      vector muv = mu;
      val(muv.x,0,0,0) = val_fm_x(fm.x,0,0,0)*(1./(clamp(ff,0,1)*(1./mu1 - 1./mu2) + 1./mu2));
    }
  } }  }}  { int jg = -1; VARIABLES;  if (is_face_y()) {
#line 97
{
...
#line 97 "/opt/basilisk/src/two-phase.h"
 {
    ...
    if (mu1 || mu2) {
      vector muv = mu;
      val(muv.y,0,0,0) = val_fm_y(fm.y,0,0,0)*(1./(clamp(ff,0,1)*(1./mu1 - 1./mu2) + 1./mu2));
    }
  } }  }}  end_foreach_face_generic()
#line 104
 end_foreach_face(); }
...
#line 105 "/opt/basilisk/src/two-phase.h"

    val(rhov,0,0,0) = val_cm(cm,0,0,0)*(clamp(val(sf,0,0,0),0.,1.)*(rho1 - rho2) + rho2); } end_foreach(); }
if (is_constant(cm)) {
const double _const_cm = _constant[cm.i -_NVARMAX];
NOT_UNUSED(_const_cm);
#undef val_cm
...
#line 105 "/opt/basilisk/src/two-phase.h"
 ...
 end_trace("properties_0", "/opt/basilisk/src/two-phase.h", 112); } return 0; } 
#line 13 "test.c"
#line 1 "tension.h"
#line 1 "/opt/basilisk/src/tension.h"
#line 15 "/opt/basilisk/src/tension.h"
#line 1 "iforce.h"
#line 1 "/opt/basilisk/src/iforce.h"
#line 20 "/opt/basilisk/src/iforce.h"
...
static int defaults_3_expr0 (int * ip, double * tp, Event * _ev) {  int i = *ip; double t = *tp;  int ret = (i = 0);   *ip = i; *tp = t;   return ret; } static int defaults_3 (const int i, const double t, Event * _ev) { trace ("defaults_3", "/opt/basilisk/src/iforce.h", 30);  {
  if (is_constant(a.x)) {
    a = new_face_vector("a");
     { foreach_face_generic() { int ig = -1; VARIABLES;  if (is_face_x()) {
#line 33
...
#line 33 "/opt/basilisk/src/iforce.h"
...
#line 34
 ...
 end_trace("defaults_3", "/opt/basilisk/src/iforce.h", 37); } return 0; } 
...
static int acceleration_0_expr0 (int * ip, double * tp, Event * _ev) {  int i = *ip; double t = *tp;  int ret = (i++);   *ip = i; *tp = t;   return ret; } static int acceleration_0 (const int i, const double t, Event * _ev) { trace ("acceleration_0", "/opt/basilisk/src/iforce.h", 44); 
{
  ...
  scalar * list = NULL;
  if (interfaces) for (scalar f = *interfaces, *_i96 = interfaces; ((scalar *)&f)->i >= 0; f = *++_i96)
...
#line 61 "/opt/basilisk/src/iforce.h"

 val(f,0,0,0) = clamp (val(f,0,0,0), 0., 1.); } end_foreach(); }
      boundary (((scalar []){f,{-1}}));
    }
#line 74 "/opt/basilisk/src/iforce.h"
  if (list) for (scalar f = *list, *_i97 = list; ((scalar *)&f)->i >= 0; f = *++_i97)
    _attribute[f.i].prolongation = _attribute[p.i].prolongation;
  boundary (list);
#line 87 "/opt/basilisk/src/iforce.h"
  vector ia = a;
   { 
...
#line 109
 end_foreach_face(); } }
  ...
  pfree (list,__func__,__FILE__,__LINE__);
 end_trace("acceleration_0", "/opt/basilisk/src/iforce.h", 131); } return 0; } 
#line 16 "/opt/basilisk/src/tension.h"
#line 1 "curvature.h"
#line 1 "/opt/basilisk/src/curvature.h"
#line 12 "/opt/basilisk/src/curvature.h"
static void curvature_restriction (Point point, scalar kappa)
{ int ig = 0; NOT_UNUSED(ig); int jg = 0; NOT_UNUSED(jg); POINT_VARIABLES; 
#line 13 "/opt/basilisk/src/curvature.h"
...
{ int ig = 0; NOT_UNUSED(ig); int jg = 0; NOT_UNUSED(jg); POINT_VARIABLES; 
#line 28 "/opt/basilisk/src/curvature.h"
...
#line 66 "/opt/basilisk/src/curvature.h"
#line 1 "heights.h"
#line 1 "/opt/basilisk/src/heights.h"
#line 29 "/opt/basilisk/src/heights.h"
...
#line 109 "/opt/basilisk/src/heights.h"
    for (int i = 1; i <= 4; i++) {
...
#line 138 "/opt/basilisk/src/heights.h"
      else if (S >= 1. && ci <= 0.) {
 H = (H - 0.5)*j + (j == -1)*20.;
 S = complete;
 break;
...
#line 156 "/opt/basilisk/src/heights.h"
...
#line 195 "/opt/basilisk/src/heights.h"
      if (state.s != complete ||
...
#line 222 "/opt/basilisk/src/heights.h"
static void column_propagation (vector h)
{
   { foreach_leaf(){

#line 224 "/opt/basilisk/src/heights.h"
...
#line 226
 ...
 if (fabs(height(val(h.y,0,i,0))) <= 3.5 &&
   ...
   val(h.y,0,0,0) = val(h.y,0,i,0) + i;}; } end_foreach_leaf(); }
  boundary ((scalar *)((vector []){{h.x,h.y},{{-1},{-1}}}));
}
#line 291 "/opt/basilisk/src/heights.h"

#line 291

static void refine_h_x (Point point, scalar h)
{ int ig = 0; NOT_UNUSED(ig); int jg = 0; NOT_UNUSED(jg); POINT_VARIABLES; 
#line 293 "/opt/basilisk/src/heights.h"
 ...
 val(h,0,0,0) = val(h,i,0,0) + i;
  ...
  if (complete)
    return;
#line 319 "/opt/basilisk/src/heights.h"
...
#line 353 "/opt/basilisk/src/heights.h"
}
#line 291
...
{ trace ("heights", "/opt/basilisk/src/heights.h", 362);
...
#line 379 "/opt/basilisk/src/heights.h"
...
#line 388 "/opt/basilisk/src/heights.h"
...
#line 400 "/opt/basilisk/src/heights.h"
       { foreach_level (l - 1){
...
#line 411 "/opt/basilisk/src/heights.h"
...
#line 420 "/opt/basilisk/src/heights.h"
...
#line 441
 ...
 delete (((scalar []){cs.x,cs.y,{-1}}));  end_trace("heights", "/opt/basilisk/src/heights.h", 448); }
...
#line 67 "/opt/basilisk/src/curvature.h"
...
{ int ig = 0; NOT_UNUSED(ig); int jg = 0; NOT_UNUSED(jg); POINT_VARIABLES; 
#line 71 "/opt/basilisk/src/curvature.h"
...
{ int ig = 0; NOT_UNUSED(ig); int jg = 0; NOT_UNUSED(jg); POINT_VARIABLES; 
#line 83 "/opt/basilisk/src/curvature.h"
...
#line 179 "/opt/basilisk/src/curvature.h"
static double height_curvature (Point point, scalar c, vector h)
{ int ig = 0; NOT_UNUSED(ig); int jg = 0; NOT_UNUSED(jg); POINT_VARIABLES; 
#line 180 "/opt/basilisk/src/curvature.h"
...
#line 211 "/opt/basilisk/src/curvature.h"
  double kappa = nodata;
  {
#line 212
...
#line 247 "/opt/basilisk/src/curvature.h"
  }
...
{ int ig = 0; NOT_UNUSED(ig); int jg = 0; NOT_UNUSED(jg); POINT_VARIABLES; 
#line 258 "/opt/basilisk/src/curvature.h"
...
#line 288 "/opt/basilisk/src/curvature.h"
...
#line 330 "/opt/basilisk/src/curvature.h"
#line 1 "parabola.h"
#line 1 "/opt/basilisk/src/parabola.h"
#line 1 "utils.h"
#line 2 "/opt/basilisk/src/parabola.h"
...
typedef struct {
  ...
  coord m;
  double ** M, rhs[3], a[3];
#line 21 "/opt/basilisk/src/parabola.h"
} ParabolaFit;
...
#line 28
  ...
  normalize (&p->m);
  int n = 3;
#line 65 "/opt/basilisk/src/parabola.h"
...
#line 111 "/opt/basilisk/src/parabola.h"
}
...
static double parabola_fit_solve (ParabolaFit * p)
{
  ...
  if (pivmin) {
    ...
    p->a[0] = p->a[1] = 0.;
#line 158 "/opt/basilisk/src/parabola.h"
  matrix_free (p->M);
  return pivmin;
}
          ...
          double kappamax, double * kmax)
{
  ...
  if (kmax)
    *kmax = fabs (kappa);
#line 190 "/opt/basilisk/src/parabola.h"
...
#line 331 "/opt/basilisk/src/curvature.h"
...
{ int ig = 0; NOT_UNUSED(ig); int jg = 0; NOT_UNUSED(jg); POINT_VARIABLES; 
#line 361 "/opt/basilisk/src/curvature.h"
...
#line 438 "/opt/basilisk/src/curvature.h"
  for (int i = 0; i < n; i++)
...
{ int ig = 0; NOT_UNUSED(ig); int jg = 0; NOT_UNUSED(jg); POINT_VARIABLES; 
#line 454 "/opt/basilisk/src/curvature.h"
...
#line 500 "/opt/basilisk/src/curvature.h"
static inline bool interfacial (Point point, scalar c)
{ int ig = 0; NOT_UNUSED(ig); int jg = 0; NOT_UNUSED(jg); POINT_VARIABLES; 
#line 501 "/opt/basilisk/src/curvature.h"
...
#line 530 "/opt/basilisk/src/curvature.h"
typedef struct {
  int h;
  int f;
  int a;
...
{ trace ("curvature", "/opt/basilisk/src/curvature.h", 545);
...
#line 569 "/opt/basilisk/src/curvature.h"
 {
...
#line 588 "/opt/basilisk/src/curvature.h"
 {
...
#line 628
  ...
  { cstats _ret =  (cstats){sh, sf, sa, sc}; delete (((scalar []){k,{-1}}));  { if (!(ch).x.i) delete (((scalar []){h.x,h.y,{-1}})); }  end_trace("curvature", "/opt/basilisk/src/curvature.h", 631);  return _ret; }
 delete (((scalar []){k,{-1}}));  { if (!(ch).x.i) delete (((scalar []){h.x,h.y,{-1}})); }  end_trace("curvature", "/opt/basilisk/src/curvature.h", 632); }
#line 651 "/opt/basilisk/src/curvature.h"

#line 651

static double pos_x (Point point, vector h, coord * G, coord * Z)
{ int ig = 0; NOT_UNUSED(ig); int jg = 0; NOT_UNUSED(jg); POINT_VARIABLES; 
#line 653 "/opt/basilisk/src/curvature.h"
...
static double height_position (Point point, scalar f, vector h,
          coord * G, coord * Z)
{ int ig = 0; NOT_UNUSED(ig); int jg = 0; NOT_UNUSED(jg); POINT_VARIABLES; 
#line 672 "/opt/basilisk/src/curvature.h"
...
#line 702 "/opt/basilisk/src/curvature.h"
  double pos = nodata;
  {
#line 703
...
#line 719 "/opt/basilisk/src/curvature.h"
struct Position {
  scalar f, pos;
  coord G, Z;
  bool add;
...
#line 742 "/opt/basilisk/src/curvature.h"
 {
...
#line 17 "/opt/basilisk/src/tension.h"
...
#line 36 "/opt/basilisk/src/tension.h"
static int stability_1_expr0 (int * ip, double * tp, Event * _ev) {  int i = *ip; double t = *tp;  int ret = (i++);   *ip = i; *tp = t;   return ret; } static int stability_1 (const int i, const double t, Event * _ev) { trace ("stability_1", "/opt/basilisk/src/tension.h", 36);  {
...
#line 43 "/opt/basilisk/src/tension.h"
 {
...
#line 47
 ...
 end_trace("stability_1", "/opt/basilisk/src/tension.h", 62); } return 0; } 
...
static int acceleration_1_expr0 (int * ip, double * tp, Event * _ev) {  int i = *ip; double t = *tp;  int ret = (i++);   *ip = i; *tp = t;   return ret; } static int acceleration_1 (const int i, const double t, Event * _ev) { trace ("acceleration_1", "/opt/basilisk/src/tension.h", 70); 
{
 ...
 end_trace("acceleration_1", "/opt/basilisk/src/tension.h", 92); } return 0; } 
#line 14 "test.c"
#line 1 "view.h"
#line 1 "/opt/basilisk/src/view.h"
#line 67 "/opt/basilisk/src/view.h"
...
#line 1 "input.h"
#line 1 "/opt/basilisk/src/input.h"
#line 16 "/opt/basilisk/src/input.h"
struct InputPGM {
...
#line 73 "/opt/basilisk/src/input.h"
 {
...
#line 96 "/opt/basilisk/src/input.h"
 {
      int i = (x - p.ox)*width/p.width, j = (y - p.oy)*width/p.width;
      if (i >= 0 && i < width && j >= 0 && j < height)
 val(s,0,0,0) = 1. - a[(height - 1 - j)*width + i]/(double)maxval;
...
#line 166 "/opt/basilisk/src/input.h"

void input_gfs (struct OutputGfs p)
{ trace ("input_gfs", "/opt/basilisk/src/input.h", 168);
  not_mpi_compatible();
  ...
  while (s1) {
    ...
    bool found = false;
    if (p.list) for (scalar s = *p.list, *_i103 = p.list; ((scalar *)&s)->i >= 0; s = *++_i103)
...
#line 273 "/opt/basilisk/src/input.h"
 {
    unsigned flags;
    ...
    if (input) for (scalar s = *input, *_i104 = input; ((scalar *)&s)->i >= 0; s = *++_i104) {
 ...
 if (_attribute[s.i].v.x.i >= 0) {
  ...
  while (t < t1 && events (false))
    t = tnext;
  events (false);
 end_trace("input_gfs", "/opt/basilisk/src/input.h", 328); }
#line 363 "/opt/basilisk/src/input.h"
struct InputGRD {
  scalar s;
  FILE * fp;
  char * file;
...
#line 415 "/opt/basilisk/src/input.h"
 {
...
#line 74 "/opt/basilisk/src/view.h"
...
static pointer compose_image (bview * view) { trace ("compose_image", "/opt/basilisk/src/view.h", 324);
  { pointer _ret =  framebuffer_image((view)->fb); end_trace("compose_image", "/opt/basilisk/src/view.h", 325);  return _ret; }
 end_trace("compose_image", "/opt/basilisk/src/view.h", 326); }
#line 419 "/opt/basilisk/src/view.h"
#line 1 "vertexbuffer.h"
#line 1 "/opt/basilisk/src/vertexbuffer.h"
#line 14 "/opt/basilisk/src/vertexbuffer.h"
struct {
...
#line 420 "/opt/basilisk/src/view.h"
...
#line 1 "draw.h"
#line 1 "/opt/basilisk/src/draw.h"
...
#line 1 "gl/font.h"
#line 1 "/opt/basilisk/src/gl/font.h"
#line 27 "/opt/basilisk/src/gl/font.h"
#include <stdio.h>
#line 1 "gl/og_font.h"
#line 1 "/opt/basilisk/src/gl/og_font.h"
...
#line 29 "/opt/basilisk/src/gl/font.h"
#line 39 "/opt/basilisk/src/gl/font.h"
extern SOG_StrokeFont ogStrokeMonoRoman;
#line 48 "/opt/basilisk/src/gl/font.h"
...
#line 83 "/opt/basilisk/src/gl/font.h"
...
#line 147 "/opt/basilisk/src/gl/font.h"
...
#line 226 "/opt/basilisk/src/gl/font.h"
...
#line 269 "/opt/basilisk/src/gl/font.h"
...
#line 321 "/opt/basilisk/src/gl/font.h"
...
#line 7 "/opt/basilisk/src/draw.h"
...
#line 47 "/opt/basilisk/src/draw.h"
struct _view_set {
  float tx, ty;
  float fov;
  float quat[4];
...
#line 231 "/opt/basilisk/src/draw.h"
struct _mirror {
  coord n;
  double alpha;
};
...
#line 371 "/opt/basilisk/src/draw.h"
...
#line 392 "/opt/basilisk/src/draw.h"
...
{ int ig = 0; NOT_UNUSED(ig); int jg = 0; NOT_UNUSED(jg); POINT_VARIABLES; 
#line 398 "/opt/basilisk/src/draw.h"
...
#line 527 "/opt/basilisk/src/draw.h"
...
#line 594 "/opt/basilisk/src/draw.h"
...
#line 651 "/opt/basilisk/src/draw.h"
struct _draw_vof {
  char * c;
  char * s;
  bool edges;
...
{ int ig = 0; NOT_UNUSED(ig); int jg = 0; NOT_UNUSED(jg); POINT_VARIABLES; 
#line 673 "/opt/basilisk/src/draw.h"
...
{ int ig = 0; NOT_UNUSED(ig); int jg = 0; NOT_UNUSED(jg); POINT_VARIABLES; 
#line 721 "/opt/basilisk/src/draw.h"
...
#line 758 "/opt/basilisk/src/draw.h"
 {
...
#line 817 "/opt/basilisk/src/draw.h"
...
#line 881 "/opt/basilisk/src/draw.h"
  if (prolongation != fraction_refine) {
  ...
  { bool _ret =  true; end_trace("draw_vof", "/opt/basilisk/src/draw.h", 888);  return _ret; }
 end_trace("draw_vof", "/opt/basilisk/src/draw.h", 889); }
#line 900 "/opt/basilisk/src/draw.h"
struct _isoline {
  char * phi;
  double val;
  int n;
...
{ trace ("isoline", "/opt/basilisk/src/draw.h", 922);

  if (!p.color) p.color = p.phi;
  scalar col = {-1}; if (p.color && strcmp (p.color, "level")) { col = compile_expression (p.color, &p.expr); if (col.i < 0) { bool _ret =  false; end_trace("isoline", "/opt/basilisk/src/draw.h", 925);  return _ret; } } double cmap[127][3]; if (p.color) { if (p.min == 0 && p.max == 0) { if (col.i < 0) p.min = 0, p.max = depth(); else { stats s = statsf (col); double avg = s.sum/s.volume; if (p.spread < 0.) p.min = s.min, p.max = s.max; else { if (!p.spread) p.spread = 5.; double spread = p.spread*s.stddev; p.min = avg - spread; p.max = avg + spread; } } } if (!p.map) p.map = jet; p.map (cmap); } if ((2 > 2 || p.linear) && !p.fc[0] && !p.fc[1] && !p.fc[2]) p.fc[0] = p.fc[1] = p.fc[2] = 1.;;
  ...
  { bool _ret =  true; delete (((scalar []){siso.x,siso.y,fiso,{-1}}));  end_trace("isoline", "/opt/basilisk/src/draw.h", 945);  return _ret; }
 delete (((scalar []){siso.x,siso.y,fiso,{-1}}));  end_trace("isoline", "/opt/basilisk/src/draw.h", 946); }
#line 959 "/opt/basilisk/src/draw.h"
struct _cells {
  coord n;
  double alpha;
  float lc[3], lw;
...
{ trace ("cells", "/opt/basilisk/src/draw.h", 967);
  bview * view = draw();
  { begin_draw_lines (view, p.lc, p.lw); {

     { foreach_visible (view){

#line 971 "/opt/basilisk/src/draw.h"
 {
...
#line 993 "/opt/basilisk/src/draw.h"
  } end_draw_lines(); }
  { bool _ret =  true; end_trace("cells", "/opt/basilisk/src/draw.h", 994);  return _ret; }
 end_trace("cells", "/opt/basilisk/src/draw.h", 995); }
...
{ trace ("vectors", "/opt/basilisk/src/draw.h", 1010);
...
#line 1026 "/opt/basilisk/src/draw.h"
 ...
 view->ni++;
  ...
  { bool _ret =  true; end_trace("vectors", "/opt/basilisk/src/draw.h", 1045);  return _ret; }
 end_trace("vectors", "/opt/basilisk/src/draw.h", 1046); }
#line 1066 "/opt/basilisk/src/draw.h"
struct _squares {
  char * color;
  char * z;
  double min, max, spread;
...
{ trace ("squares", "/opt/basilisk/src/draw.h", 1081);
  ...
  if (p.z) {
    ...
    if (Z.i < 0)
      { bool _ret =  false; end_trace("squares", "/opt/basilisk/src/draw.h", 1089);  return _ret; }
    n = new_vector("n");
     { foreach(){

#line 1091 "/opt/basilisk/src/draw.h"
...
#line 1092
  ...
  scalar col = {-1}; if (p.color && strcmp (p.color, "level")) { col = compile_expression (p.color, &p.expr); if (col.i < 0) { bool _ret =  false; end_trace("squares", "/opt/basilisk/src/draw.h", 1097);  return _ret; } } double cmap[127][3]; if (p.color) { if (p.min == 0 && p.max == 0) { if (col.i < 0) p.min = 0, p.max = depth(); else { stats s = statsf (col); double avg = s.sum/s.volume; if (p.spread < 0.) p.min = s.min, p.max = s.max; else { if (!p.spread) p.spread = 5.; double spread = p.spread*s.stddev; p.min = avg - spread; p.max = avg + spread; } } } if (!p.map) p.map = jet; p.map (cmap); } if ((2 > 2 || p.linear) && !p.fc[0] && !p.fc[1] && !p.fc[2]) p.fc[0] = p.fc[1] = p.fc[2] = 1.;;
  scalar f = col;

  bview * view = draw();
  glShadeModel (GL_SMOOTH);
  if (p.linear) {
    { begin_colorized (p.fc, !p.color, cmap, !VertexBuffer.color && p.color && p.linear && col.i >= 0); {

      if (Z.i < 0) {
 vertex_buffer_glNormal3d (0, 0, view->reversed ? -1 : 1);
  { foreach_visible (view){

#line 1107 "/opt/basilisk/src/draw.h"
...
#line 1131 "/opt/basilisk/src/draw.h"
...
#line 1182 "/opt/basilisk/src/draw.h"
    } end_colorized(); }
  }
  else {
...
#line 1188 "/opt/basilisk/src/draw.h"
 ...
 view->ni++;
    ...
    vertex_buffer_glEnd();
#line 1218 "/opt/basilisk/src/draw.h"
  }
  if (p.expr) delete (((scalar []){col,{-1}}));
  ...
  { bool _ret =  true; end_trace("squares", "/opt/basilisk/src/draw.h", 1224);  return _ret; }
 end_trace("squares", "/opt/basilisk/src/draw.h", 1225); }
#line 1236 "/opt/basilisk/src/draw.h"
struct _box {
  bool notics;
  float lc[3], lw;
};
...
{ trace ("box", "/opt/basilisk/src/draw.h", 1243);
  bview * view = draw();
  { begin_draw_lines (view, p.lc, p.lw); {
 ...
 gl_StrokeString (label);
 glPopMatrix();
#line 1285 "/opt/basilisk/src/draw.h"
      }
      ...
      gl_StrokeString ("Y");
      glPopMatrix();
#line 1316 "/opt/basilisk/src/draw.h"
    }


     { foreach_level (0){

#line 1319 "/opt/basilisk/src/draw.h"
 {
      vertex_buffer_glBegin (GL_LINE_LOOP);
      glvertex2d (view, x - Delta_x/2., y - Delta_y/2.);
      glvertex2d (view, x + Delta_x/2., y - Delta_y/2.);
...
#line 1348 "/opt/basilisk/src/draw.h"
  } end_draw_lines(); }
  { bool _ret =  true; end_trace("box", "/opt/basilisk/src/draw.h", 1349);  return _ret; }
 end_trace("box", "/opt/basilisk/src/draw.h", 1350); }
#line 1363 "/opt/basilisk/src/draw.h"
struct _isosurface {
  char * f;
  double v;
...
{ trace ("isosurface", "/opt/basilisk/src/draw.h", 1377);
#line 1438 "/opt/basilisk/src/draw.h"
  { bool _ret =  true; end_trace("isosurface", "/opt/basilisk/src/draw.h", 1438);  return _ret; }
 end_trace("isosurface", "/opt/basilisk/src/draw.h", 1439); }
#line 1449 "/opt/basilisk/src/draw.h"
struct _travelling {
  double start, end;
...
#line 1496 "/opt/basilisk/src/draw.h"
struct _draw_string {
  char * str;
  int pos;
  float size;
...
{ trace ("draw_string", "/opt/basilisk/src/draw.h", 1505);
  bview * view = draw();
  ...
  { bool _ret =  true; end_trace("draw_string", "/opt/basilisk/src/draw.h", 1540);  return _ret; }
 end_trace("draw_string", "/opt/basilisk/src/draw.h", 1541); }
...
{ trace ("labels", "/opt/basilisk/src/draw.h", 1553);

  bool expr = false;
  scalar f = compile_expression (p.f, &expr);
  if (f.i < 0)
    { bool _ret =  false; end_trace("labels", "/opt/basilisk/src/draw.h", 1558);  return _ret; }
  bview * view = draw();
  float width = gl_StrokeWidth ('1'), height = gl_StrokeHeight();
  float res = view->res;
...
#line 1566 "/opt/basilisk/src/draw.h"
 ...
 glPopMatrix();
  ...
  { bool _ret =  true; end_trace("labels", "/opt/basilisk/src/draw.h", 1580);  return _ret; }




 end_trace("labels", "/opt/basilisk/src/draw.h", 1585); }
...
#line 1 "draw_json.h"
#line 1 "/opt/basilisk/src/draw_json.h"
...
#line 1594 "/opt/basilisk/src/draw.h"
...
#line 427 "/opt/basilisk/src/view.h"
#line 442 "/opt/basilisk/src/view.h"
struct _load {
  FILE * fp;
  char * file;
  Array * buf;
...
#line 496 "/opt/basilisk/src/view.h"
struct _save {
...
{ trace ("save", "/opt/basilisk/src/view.h", 516);
  char ppm[] = "ppm";
  if (!p.format) {
    p.format = ppm;
    if (p.file) {
 ...
 p.format = dot + 1;
  ...
  if (!strcmp (p.format, "png") ||
    ...
    if (pid() == 0) {
      ...
      if (!fp) {
 perror (p.file);
 { bool _ret =  false; end_trace("save", "/opt/basilisk/src/view.h", 542);  return _ret; }
      }
      gl_write_image (fp, image, view->width, view->height, view->samples);
      close_image (p.file, fp);
    }
    { bool _ret =  true; end_trace("save", "/opt/basilisk/src/view.h", 547);  return _ret; }
  }

  if (p.file && (p.fp = fopen (p.file, "w")) == NULL) {
    perror (p.file);
    { bool _ret =  false; end_trace("save", "/opt/basilisk/src/view.h", 552);  return _ret; }
  }
  if (!p.fp)
    p.fp = fout;
  ...
  if (!strcmp (p.format, "ppm")) {
    ...
    fprintf (ferr, "save(): error: the '%s' format is no longer supported\n",
      p.format);
#line 584 "/opt/basilisk/src/view.h"
  }
    ...
    { bool _ret =  false; end_trace("save", "/opt/basilisk/src/view.h", 604);  return _ret; }
  }
  ...
  { bool _ret =  true; end_trace("save", "/opt/basilisk/src/view.h", 611);  return _ret; }
 end_trace("save", "/opt/basilisk/src/view.h", 612); }
...
static void fields_stats()
{
  ...
  if (all) for (scalar s = *all, *_i105 = all; ((scalar *)&s)->i >= 0; s = *++_i105)
...
#line 1 "draw_get.h"
#line 1 "/opt/basilisk/src/draw_get.h"

#line 1 "parse.h"
#line 1 "/opt/basilisk/src/parse.h"
...
#line 3 "/opt/basilisk/src/draw_get.h"
...
#line 657 "/opt/basilisk/src/view.h"
...
static void _set_boundary4 (void) { _attribute[u.y.i].boundary[top] = _boundary4; _attribute[u.y.i].boundary_homogeneous[top] = _boundary4_homogeneous; } 
...
static void _set_boundary6 (void) { _attribute[u.y.i].boundary[bottom] = _boundary6; _attribute[u.y.i].boundary_homogeneous[bottom] = _boundary6_homogeneous; } 
static void _set_boundary7 (void) { _attribute[u.x.i].boundary[bottom] = _boundary7; _attribute[u.x.i].boundary_homogeneous[bottom] = _boundary7_homogeneous; } 
#line 59 "test.c"
int main() { _init_solver();
  L0 = 8.;
  origin((struct _origin){-L0/2., -0.5});
  tree_periodic(right);
  init_grid (1 << 8);
  ...
  rho1 = 1.0;
  rho2 = (917.0/1000.0);
  mu1 = 1/(1000.0*10.0*0.00001/0.001);
  mu2 = (0.03/0.001)*mu1;
  _attribute[f.i].sigma=1/(1000.0*pow(10.0,2)*0.00001/0.0728);
...
static int init_0_expr0 (int * ip, double * tp, Event * _ev) {  int i = *ip; double t = *tp;  int ret = (t = 0);   *ip = i; *tp = t;   return ret; } static int init_0 (const int i, const double t, Event * _ev) { trace ("init_0", "test.c", 115);  {
...
#line 124 "test.c"
 { if (is_leaf(cell)) { int bid = (y > 0.5 ? top : -1); if (bid >= 0) cell.pid = - bid - 1; } else { int pid = -1;  { foreach_child() if (cell.pid >= 0 || pid < 0) pid = cell.pid; end_foreach_child(); } cell.pid = pid; if (pid < 0) { cell.flags |= leaf; decrement_neighbors (point); } } } } end_foreach_cell_post(); } ((Tree *)grid)->dirty = true; };
  {  { foreach_cell_post(!is_leaf(cell)){

#line 125 "test.c"
 { if (is_leaf(cell)) { int bid = (y < -0.5 ? bottom : -1); if (bid >= 0) cell.pid = - bid - 1; } else { int pid = -1;  { foreach_child() if (cell.pid >= 0 || pid < 0) pid = cell.pid; end_foreach_child(); } cell.pid = pid; if (pid < 0) { cell.flags |= leaf; decrement_neighbors (point); } } } } end_foreach_cell_post(); } ((Tree *)grid)->dirty = true; };

  do { scalar phi= new_vertex_scalar("phi");  { foreach_vertex(){

#line 127 "test.c"
 val(phi,0,0,0) = 0.3-y; } end_foreach_vertex(); } boundary (((scalar []){phi,{-1}})); fractions ((struct Fractions){phi, f});  delete (((scalar []){phi,{-1}})); } while(0);


  _attribute[u.y.i].boundary[top] = _boundary8; _attribute[u.y.i].boundary_homogeneous[top] = _boundary8_homogeneous;
  _attribute[u.y.i].boundary[bottom] = _boundary9; _attribute[u.y.i].boundary_homogeneous[bottom] = _boundary9_homogeneous;

 end_trace("init_0", "test.c", 133); } return 0; } 





static int adapt_0_expr0 (int * ip, double * tp, Event * _ev) {  int i = *ip; double t = *tp;  int ret = (i++);   *ip = i; *tp = t;   return ret; } static int adapt_0 (const int i, const double t, Event * _ev) { trace ("adapt_0", "test.c", 139); 
{
  ...
  adapt_wavelet((struct Adapt){(scalar *)((scalar []){f,u.x,u.y,{-1}}), (double[]){1e-6, 1e-2, 1e-2}, 7, 4});
#line 180 "test.c"
 end_trace("adapt_0", "test.c", 180); } return 0; } 

static int end_expr0 (int * ip, double * tp, Event * _ev) {  int i = *ip; double t = *tp;  int ret = (t = 100);   *ip = i; *tp = t;   return ret; } static int end (const int i, const double t, Event * _ev) { trace ("end", "test.c", 182);  {
  printf ("i = %d t = %g\n", i, t);
 end_trace("end", "test.c", 184); } return 0; } 
#line 198 "test.c"
static int gfsview_expr0 (int * ip, double * tp, Event * _ev) {  int i = *ip; double t = *tp;  int ret = (t += 1.0);   *ip = i; *tp = t;   return ret; } static int gfsview (const int i, const double t, Event * _ev) { trace ("gfsview", "test.c", 198);  {
    char name_gfs[200];
    sprintf(name_gfs,"Slice-%0.1f.gfs",t);

    FILE* fp_gfs = fopen (name_gfs, "w");
    output_gfs ((struct OutputGfs){fp_gfs});
    fclose(fp_gfs);
 end_trace("gfsview", "test.c", 205); } return 0; } 
#line 253 "test.c"
static int interface_expr0 (int * ip, double * tp, Event * _ev) {  int i = *ip; double t = *tp;  int ret = (t+=1);   *ip = i; *tp = t;   return ret; } static int interface (const int i, const double t, Event * _ev) { trace ("interface", "test.c", 253); 
{
  char name_interface[1000];
  sprintf(name_interface, "interface_%g.dat", t);

  FILE * fp2 = fopen(name_interface, "w");
  output_facets ((struct OutputFacets){f, fp2});
 end_trace("interface", "test.c", 260); } return 0; } 

static int loginterface_expr0 (int * ip, double * tp, Event * _ev) {  int i = *ip; double t = *tp;  int ret = (t += 1.0);   *ip = i; *tp = t;   return ret; } static int loginterface (const int i, const double t, Event * _ev) { trace ("loginterface", "test.c", 262);  {
    scalar posX= new_scalar("posX"),posY= new_scalar("posY");
    position ((struct Position){f, posX, {1, 0}});
    position ((struct Position){f, posY, {0,1}});
    ...
    fflush(fp_interface);
 delete (((scalar []){posY,posX,{-1}}));  end_trace("loginterface", "test.c", 268); } return 0; } 

static int profiles_expr0 (int * ip, double * tp, Event * _ev) {  int i = *ip; double t = *tp;  int ret = (t = 0);   *ip = i; *tp = t;   return ret; } static int profiles_expr1 (int * ip, double * tp, Event * _ev) {   int i = *ip; double t = *tp;   int ret = ( t+=1.0);   *ip = i; *tp = t;   return ret; } static int profiles_expr2 (int * ip, double * tp, Event * _ev) {   int i = *ip; double t = *tp;   int ret = ( t<=100);   *ip = i; *tp = t;   return ret; } static int profiles (const int i, const double t, Event * _ev) { trace ("profiles", "test.c", 270); 
{
  FILE * fp = fopen("xprof", "a");
  for (double y = -0.5; y <= 0.5; y += 0.01)
    fprintf (fp, "%g %g %g\n", t, y, interpolate ((struct _interpolate){u.x, 0, y}));
  fclose (fp);

  fp = fopen("yprof", "a");
  for (double x = -4; x <= 4; x += 0.01)
    fprintf (fp, "%g %g %g\n", t, x, interpolate ((struct _interpolate){u.y, x, 0}));
  fclose (fp);
#line 307 "test.c"
 end_trace("profiles", "test.c", 307); } return 0; } 

static int vortmovie_expr0 (int * ip, double * tp, Event * _ev) {  int i = *ip; double t = *tp;  int ret = (t+=1.0);   *ip = i; *tp = t;   return ret; } static int vortmovie (const int i, const double t, Event * _ev) { trace ("vortmovie", "test.c", 309); 
{
  scalar omega= new_scalar("omega");
  vorticity(u, omega);

  view ((struct _view_set){.fov=3, .width=2600, .height=400});
  clear();
  squares((struct _squares){"omega", .spread=-1.0, .linear=true, .map=cool_warm});


  save((struct _save){"Vorticity.mp4"});
 delete (((scalar []){omega,{-1}}));  end_trace("vortmovie", "test.c", 320); } return 0; } 
#line 91 "/opt/basilisk/src/navier-stokes/centered.h"
