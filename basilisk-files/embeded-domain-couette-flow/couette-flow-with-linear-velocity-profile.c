...
int main() {                // Main program begins here
	...
	origin (0.0, 0.0);  // Origin is at the bottom centre of the box
	N = 32 ; 
...
event init (t=0)
{
     ...
     foreach()
	  ...
	  u.x[] = cs[] ? 0.0  : 0.;	//(IT DOESNT ) 	THIS LINE IS COMMENTED TO CHECK IF THE CODE STILL RUNS 
