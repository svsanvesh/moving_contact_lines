//This code is replicated from http://basilisk.fr/src/examples/gaussian-ns.c and is written primarily to investigate the use of vof and embed boundaries. 
//Author : ANVESH 
//Comments: 
//Status: 
//Method to compile the code: qcc -O2 bump-flow.c -L$BASILISK/gl -lglutils -lfb_osmesa -lGLU -lOSMesa -lm
